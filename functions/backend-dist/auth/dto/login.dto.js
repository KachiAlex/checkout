...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Tenant slug/company identifier', example: 'acme-retail' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Device ID for device registration', required: false }),
