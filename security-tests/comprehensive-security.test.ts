...
describe('Comprehensive Security Tests', () => {
  const API_BASE = process.env.VITE_API_URL || 'https://lyxwslsckkbcpepxigdx.supabase.co/functions/v1/api/v1';
  ...
  describe('1. JWT Security', () => {
    ...
    it('should reject requests with tampered JWT signature', async () => {
      ...
      const fakeToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0NTY3ODkwIiwidGVuYW50SWQiOiJ0ZXN0In0.tampered-signature';
      const response = await fetch(`${API_BASE}/orders`, {
        method: 'GET',
        headers: {
    ...
    it('should reject expired JWT tokens', async () => {
      ...
      const expiredToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxMjM0IiwidGVuYW50SWQiOiJ0ZXN0IiwiZXhwIjoxNjAwMDAwMDAwfQ.expired';
      const response = await fetch(`${API_BASE}/orders`, {
        method: 'GET',
        headers: {
