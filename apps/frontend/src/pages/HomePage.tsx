      ...
      <div className="relative min-h-screen overflow-x-hidden bg-slate-950 text-slate-100">
        ...
        <header className="relative z-10">
          <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-9">
            <Link
              to="/"
              className="flex items-center gap-1.5 sm:gap-2 text-base sm:text-lg font-semibold tracking-tight text-slate-100"
            >
              <BrandMark
                size={32}
                withPadding={false}
        ...
        <main className="relative z-10">
          <section className="mx-auto flex w-full max-w-7xl flex-col gap-8 sm:gap-12 lg:gap-16 px-3 sm:px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-24 pt-6 sm:pt-8 lg:pt-10 md:flex-row md:items-center">
            <div className="md:w-1/2 lg:w-7/12">
              ...
              <p className="mt-5 sm:mt-6 text-base sm:text-lg lg:text-xl text-slate-300 leading-relaxed">
                Whether you run a pharmacy, restaurant, retail store, or
                supermarket—<strong className="text-white">Checkout POS</strong>{" "}
                helps you sell faster, manage inventory smarter, and grow your
                revenue with real-time insights.
              </p>
              ...
              <div className="mt-10 sm:mt-12 grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                {outcomes.map((item) => (
                  ...
                  >
                    ...
                    <p className="text-xl sm:text-2xl lg:text-3xl font-bold text-white group-hover:scale-110 transition-transform">
                      {item.value}
                    </p>
                    <p className="text-[10px] sm:text-xs uppercase tracking-wide text-slate-400 mt-2">
                      {item.label}
                    </p>
                  </div>
                ))}
            ...
            <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 lg:px-6">
              <div className="text-center mb-10 sm:mb-14">
                ...
                <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-3xl mx-auto">
                  Every minute counts in retail. Checkout POS helps you sell
                  faster, waste less, and make better decisions.
                </p>
              </div>
          ...
          <section id="industries" className="py-12 sm:py-16 lg:py-24">
            <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 lg:px-6">
              <div className="text-center mb-10 sm:mb-16">
                ...
                <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-3xl mx-auto">
                  Whether you sell clothes, medicine, food, or
                  groceries—Checkout has the features you need.
                </p>
              </div>
                    ...
                    <div className="relative">
                      <div className="flex items-start justify-between mb-5">
                        ...
                        <div className="text-right">
                          <div
                            className={`text-2xl sm:text-3xl font-bold bg-gradient-to-r ${industry.gradient} bg-clip-text text-transparent`}
                          >
          ...
          <section
            id="features"
            className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 py-12 sm:py-16 lg:py-24 backdrop-blur-xl border-y border-white/5"
          >
            <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 lg:px-6">
              <div className="text-center mb-10 sm:mb-14">
                ...
                <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-3xl mx-auto">
                  From checkout to inventory, reports to customer management—all
                  in one beautiful, easy-to-use platform.
                </p>
              </div>
              ...
              <div className="grid gap-5 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <div className="relative">
                      <div
                        className={`inline-flex items-center justify-center h-14 w-14 sm:h-16 sm:w-16 rounded-2xl bg-gradient-to-br ${feature.gradient} text-3xl sm:text-4xl mb-5 shadow-lg`}
                      >
                        {feature.icon}
                      </div>
              ...
              <div className="mt-12 sm:mt-16 grid gap-4 sm:gap-6 md:grid-cols-3">
                <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-sky-500/10 to-transparent p-5 sm:p-6">
                  ...
                  <p className="text-sm text-slate-400">
                    Works with barcode scanners, receipt printers, cash drawers,
                    and card readers
                  </p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-emerald-500/10 to-transparent p-5 sm:p-6">
                  ...
                  <p className="text-sm text-slate-400">
                    Access from anywhere, work without internet, auto-sync when
                    back online
                  </p>
                </div>
                <div className="rounded-2xl border border-white/10 bg-gradient-to-br from-purple-500/10 to-transparent p-5 sm:p-6">
                  ...
                  <p className="text-sm text-slate-400">
                    Bank-level encryption, audit trails, and GDPR-compliant data
                    handling
                  </p>
                </div>
              </div>
          ...
          <section id="stories" className="py-12 sm:py-16 lg:py-24">
            <div className="mx-auto w-full max-w-7xl px-3 sm:px-4 lg:px-6">
              <div className="mb-10 sm:mb-14 text-center">
                ...
                <p className="mt-4 text-base sm:text-lg text-slate-300 max-w-3xl mx-auto">
                  See how Checkout POS is transforming businesses across Nigeria
                  and beyond.
                </p>
              </div>
              ...
              <div className="grid gap-5 sm:gap-6 md:grid-cols-2 lg:grid-cols-2">
                {testimonials.map((item, index) => (
                  ...
                  >
                    ...
                    <div className="relative">
                      {/* Quote icon */}
                      <div className="text-5xl sm:text-6xl text-sky-400/20 mb-4">
                        "
                      </div>
          ...
          <section id="pricing" className="py-12 sm:py-16 lg:py-20">
            <div className="mx-auto w-full max-w-6xl px-3 sm:px-4 lg:px-6">
              <div className="text-center mb-8 sm:mb-12">
                <p className="text-[10px] sm:text-xs uppercase tracking-[0.4em] text-sky-200">
                  Pricing
                </p>
                ...
                <p className="mt-3 sm:mt-4 text-sm sm:text-base text-slate-300 max-w-2xl mx-auto">
                  Choose the plan that works best for your business. Start with
                  a 14-day free trial.
                </p>
              </div>
                  ...
                  <div className="rounded-2xl sm:rounded-3xl border border-emerald-500/30 bg-emerald-500/10 p-6 sm:p-8 shadow-[0_20px_60px_-30px_rgba(16,185,129,0.4)] backdrop-blur-xl hover:border-emerald-400/40 transition">
                    <div className="text-center">
                      ...
                      <p className="text-xs sm:text-sm text-emerald-300 mt-1">
                        {pricing.free.durationDays} day trial
                      </p>
                          ...
                          <>
                            <div>
                              ...
                              <p className="text-2xl sm:text-3xl font-semibold text-white">
                                {formatPrice(pricing.free.priceCents)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-400 mb-1">
                        ...
                        {loadingPricing ? (
                          ...
                          <>
                            <div>
                              ...
                              <p className="text-2xl sm:text-3xl font-semibold text-white">
                                {formatPrice(pricing.starter.priceCents)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-400 mb-1">
                        ...
                        {loadingPricing ? (
                          ...
                          <>
                            <div>
                              ...
                              <p className="text-2xl sm:text-3xl font-semibold text-white">
                                {formatPrice(pricing.professional.priceCents)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-300 mb-1">
                              ...
                              <p className="text-lg sm:text-xl font-semibold text-white">
                                {formatLimit(pricing.professional.locations)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-300 mb-1">
                              ...
                              <p className="text-lg sm:text-xl font-semibold text-white">
                                {formatLimit(pricing.professional.users || 15)}
                              </p>
                            </div>
                          </>
                        )}
                        ...
                        {loadingPricing ? (
                          ...
                          <>
                            <div>
                              ...
                              <p className="text-2xl sm:text-3xl font-semibold text-white">
                                {formatPrice(pricing.lifetime.priceCents)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-400 mb-1">
                              ...
                              <p className="text-lg sm:text-xl font-semibold text-white">
                                {formatLimit(pricing.lifetime.locations)}
                              </p>
                            </div>
                            <div>
                              <p className="text-xs sm:text-sm text-slate-400 mb-1">
                              ...
                              <p className="text-lg sm:text-xl font-semibold text-white">
                                {formatLimit(pricing.lifetime.users)}
                              </p>
                            </div>
                          </>
                        )}
          ...
          <section className="py-16 sm:py-20 lg:py-28 px-3 sm:px-4">
            <div className="mx-auto w-full max-w-6xl">
              <div className="relative rounded-[32px] sm:rounded-[48px] border border-white/10 bg-gradient-to-br from-emerald-400/20 via-sky-500/15 to-indigo-500/20 p-8 sm:p-12 lg:p-16 text-center shadow-[0_45px_120px_-60px_rgba(56,189,248,0.7)] backdrop-blur-2xl overflow-hidden">
                ...
                <div
                  className="absolute -bottom-20 -right-20 h-60 w-60 rounded-full bg-sky-500/30 blur-3xl animate-pulse"
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center justify-center gap-2 text-amber-400 text-xl sm:text-2xl">
                    ...
                    <span className="ml-2 text-sm sm:text-base text-slate-300">
          ...
          <div className="mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 text-sm text-slate-400 md:flex-row md:items-start md:justify-between">
            <div>
              ...
              <p className="mt-2 text-xs uppercase tracking-[0.25em]">
                Point-of-sale platform for ambitious retail teams
              </p>
