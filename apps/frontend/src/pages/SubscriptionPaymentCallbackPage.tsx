      ...
      <div className="max-w-md w-full theme-surface rounded-2xl border theme-border p-8 text-center">
        ...
        {status === 'loading' && (
          <>
            ...
            <h2 className="text-xl font-semibold theme-text-primary mb-2">Verifying Payment...</h2>
            <p className="theme-text-secondary text-sm">Please wait while we confirm your payment.</p>
          </>
        )}
        ...
        {status === 'success' && (
          <>
            ...
            <h2 className="text-xl font-semibold theme-text-primary mb-2">Payment Successful!</h2>
        ...
        {status === 'failed' && (
          <>
            <div className="text-6xl mb-4">❌</div>
            <h2 className="text-xl font-semibold theme-text-primary mb-2">Payment Failed</h2>
            <p className="theme-text-secondary text-sm mb-4">
