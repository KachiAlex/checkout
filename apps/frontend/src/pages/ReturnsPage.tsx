    ...
    <div className="theme-background min-h-screen">
      <div className="relative mx-auto w-full max-w-7xl space-y-6 px-6 py-10">
        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="theme-text-primary text-3xl font-bold">Returns & Refunds</h1>
            <p className="theme-text-secondary mt-1 text-sm">Process returns and refunds for orders</p>
          </div>
          <button
