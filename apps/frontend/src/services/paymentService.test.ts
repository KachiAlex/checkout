...
import { PaymentService, InitiatePaymentRequest, PaymentResponse, PaymentStatusResponse } from './paymentService';
...
describe('PaymentService', () => {
  ...
  describe('initiatePayment', () => {
    ...
    it('should handle different payment methods', async () => {
      const methods: Array<'card' | 'qr' | 'cash' | 'transfer'> = ['card', 'qr', 'cash', 'transfer'];
  ...
  describe('capturePayment', () => {
    ...
    it('should capture payment successfully', async () => {
      ...
      const result = await PaymentService.capturePayment('order-123', 'payment-123');
  ...
  describe('refundPayment', () => {
    ...
    it('should refund full payment', async () => {
      ...
      const result = await PaymentService.refundPayment('order-123', 'payment-123');
    ...
    it('should refund partial amount', async () => {
      ...
      const result = await PaymentService.refundPayment('order-123', 'payment-123', 5000);
