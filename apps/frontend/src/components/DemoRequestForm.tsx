  ...
  return (
    <div className="theme-card rounded-2xl sm:rounded-3xl border px-4 py-6 sm:px-6 sm:py-8 backdrop-blur-xl max-w-2xl">
      <div className="mb-6 text-center">
        <h2 className="theme-text-primary text-xl sm:text-2xl font-bold mb-2">Schedule a Demo</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label htmlFor="name" className="theme-text-secondary text-sm font-medium mb-1 block">
              Full Name *
            </label>
            <input
              id="name"
          ...
          <div>
            <label htmlFor="email" className="theme-text-secondary text-sm font-medium mb-1 block">
              Email Address *
            </label>
            <input
              id="email"
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            <label htmlFor="phone" className="theme-text-secondary text-sm font-medium mb-1 block">
              Phone Number
            </label>
            <input
              id="phone"
        ...
        <div>
          <label htmlFor="industry" className="theme-text-secondary text-sm font-medium mb-1 block">
            Industry Type *
          </label>
          <select
            id="industry"
        ...
        <div>
          <label htmlFor="message" className="theme-text-secondary text-sm font-medium mb-1 block">
