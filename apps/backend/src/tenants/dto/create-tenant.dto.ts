...
export class CreateTenantDto {
  ...
  @ApiProperty({
    description: 'Billing cycle start date (ISO format)',
    required: false,
    example: '2025-01-01',
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Billing cycle end date (ISO format)',
    required: false,
    example: '2025-12-31',
  })
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Custom feature flags (will be merged with industry defaults)',
    required: false,
  })
  @IsOptional()
  @ValidateNested()
