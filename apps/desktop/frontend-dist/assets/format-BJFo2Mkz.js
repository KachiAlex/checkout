...
function o(e, n) {
  ...
  const s = a(),
    c =
      ...
      (null ==
      (o = null == (r = null == n ? void 0 : n.locale) ? void 0 : r.options)
        ? void 0
        : o.weekStartsOn) ??
      s.weekStartsOn ??
      (null == (u = null == (i = s.locale) ? void 0 : i.options)
        ? void 0
        : u.weekStartsOn) ??
      0,
    d = t(e),
...
function w(t) {
  return (e, n = {}) => {
    ...
    return { value: c, rest: e.slice(i.length) };
  };
}
var b;
const y = {
  ...
  match: {
    ordinalNumber:
      ...
      (t, e = {}) => {
        const n = t.match(b.matchPattern);
        if (!n) return null;
        const r = n[0],
          a = t.match(b.parsePattern);
        if (!a) return null;
        let o = b.valueCallback ? b.valueCallback(a[0]) : a[0];
        return (
    ...
    a = (function (t, e) {
      ...
      (function (n) {
        const r = t(n),
          a = e(n, 0);
        return (
          a.setFullYear(r.getFullYear(), 0, 1),
          a.setHours(0, 0, 0, 0),
          a
        );
      })(r),
...
function M(n, r) {
  ...
  const d = t(n),
    ...
    h = a(),
    m =
      (null == r ? void 0 : r.firstWeekContainsDate) ??
      (null ==
      (u = null == (i = null == r ? void 0 : r.locale) ? void 0 : i.options)
        ? void 0
        : u.firstWeekContainsDate) ??
      h.firstWeekContainsDate ??
      (null == (c = null == (s = h.locale) ? void 0 : s.options)
        ? void 0
  ...
  const g = o(f, r),
    w = e(n, 0);
  (w.setFullYear(l, 0, m), w.setHours(0, 0, 0, 0));
  const b = o(w, r);
      ...
      +(function (t, n) {
        ...
        const c = a(),
          d =
            ...
            (null ==
            (i =
              null == (r = null == n ? void 0 : n.locale) ? void 0 : r.options)
              ? void 0
              : i.firstWeekContainsDate) ??
            c.firstWeekContainsDate ??
            (null == (s = null == (u = c.locale) ? void 0 : u.options)
              ? void 0
              : s.firstWeekContainsDate) ??
            1,
          l = M(t, n),
          h = e(t, 0);
        return (h.setFullYear(l, 0, d), h.setHours(0, 0, 0, 0), o(h, n));
      })(u, i);
...
const P = {
  ...
  N = {
    ...
    Y: function (t, e, n, r) {
      ...
      return "Yo" === e ? n.ordinalNumber(o, { unit: "year" }) : k(o, e.length);
    },
    R: function (t, e) {
      return k(u(t), e.length);
    },
    u: function (t, e) {
    ...
    w: function (t, e, n, r) {
      const a = x(t, r);
      return "wo" === e ? n.ordinalNumber(a, { unit: "week" }) : k(a, e.length);
    },
    I: function (t, e, n) {
      const r = p(t);
      return "Io" === e ? n.ordinalNumber(r, { unit: "week" }) : k(r, e.length);
    },
    d: function (t, e, n) {
      return "do" === e
    ...
    B: function (t, e, n) {
      const r = t.getHours();
      let a;
      switch (((a = r >= 17 ? Y : r >= 12 ? T : r >= 4 ? D : C), e)) {
        case "B":
        case "BB":
        case "BBB":
          return n.dayPeriod(a, {
    ...
    K: function (t, e, n) {
      ...
      return "Ko" === e ? n.ordinalNumber(r, { unit: "hour" }) : k(r, e.length);
    },
    k: function (t, e, n) {
      let r = t.getHours();
      return (
...
const H = (t, e) => {
  ...
  j = {
    ...
    P: (t, e) => {
      ...
      return o.replace("{{date}}", H(r, e)).replace("{{time}}", E(a, e));
    },
  },
  z = /^D+$/,
  L = /^Y+$/,
  Q = ["D", "DD", "YY", "YYYY"];
const G = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g,
  X = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g,
  A = /^'([^]*?)'?$/,
  B = /''/g,
  $ = /[a-zA-Z]/;
function J(e, n, r) {
  ...
  const c = a(),
    ...
    h =
      c.firstWeekContainsDate ??
      (null == (i = null == (o = c.locale) ? void 0 : o.options)
        ? void 0
        : i.firstWeekContainsDate) ??
      1,
    m =
      ...
      0,
    f = t(e);
  if (!d(f)) throw new RangeError("Invalid time value");
  let g = n
    .match(X)
    .map((t) => {
      const e = t[0];
      if ("p" === e || "P" === e) {
        return (0, j[e])(t, l.formatLong);
      }
      return t;
    })
    .join("")
    ...
    .map((t) => {
      ...
      const e = t[0];
      if ("'" === e) return { isToken: !1, value: I(t) };
      if (N[e]) return { isToken: !0, value: t };
      if (e.match($))
  ...
  l.localize.preprocessor && (g = l.localize.preprocessor(f, g));
  const w = { firstWeekContainsDate: h, weekStartsOn: m, locale: l };
  return g
    .map((t) => {
      ...
      ((function (t) {
        ...
        (function (t, e, n) {
          ...
          if (Q.includes(t)) throw new RangeError(r);
        })(r, n, String(e));
      return (0, N[r[0]])(f, r, l.localize, w);
    })
    .join("");
}
function I(t) {
