...
import { S as l, a as d, h as i, p as c } from "./ScannerInput-Ci9-hhYG.js";
import { B as m } from "./BrandMark-HxNEMnER.js";
import { T as u } from "./ThemeToggle-TO1YIz9m.js";
import { f as x } from "./format-BJFo2Mkz.js";
...
function p() {
  const { user: p, logout: h, accessToken: b } = e(),
    ...
    E = async () => {
      var e, t, s;
      if (!b || !p) return;
      const a = p.locationId;
      if (a) {
        k(!0);
        try {
          const e =
            (
              await r.get(`${n}/api/v1/inventory/${a}/stock`, {
          ...
          for (const s of e)
            try {
              const e = await r.get(
                `${n}/api/v1/inventory/${a}/batch/${s.productId}`,
                { headers: { Authorization: `Bearer ${b}` } },
              );
              t[s.productId] = e.data || [];
            } catch (l) {
              t[s.productId] = [];
            }
          N(t);
        } catch (l) {
          401 !== (null == (e = l.response) ? void 0 : e.status) &&
            o.error(
              (null == (s = null == (t = l.response) ? void 0 : t.data)
                ? void 0
                : s.message) || "Failed to load inventory",
            );
        } finally {
          k(!1);
        }
    ...
    L = async () => {
      if (b && (null == p ? void 0 : p.locationId))
        try {
          const e = await r.get(
            `${n}/api/v1/inventory/${p.locationId}/transactions`,
            { headers: { Authorization: `Bearer ${b}` } },
          );
          g(e.data || []);
        } catch (e) {}
  ...
  t.useEffect(() => {
    p &&
      ...
      (async () => {
        ...
        if (b)
          try {
            const e = await r.get(`${n}/api/v1/categories`, {
              headers: { Authorization: `Bearer ${b}` },
            });
            M(e.data || []);
          } catch (t) {
            401 !== (null == (e = t.response) ? void 0 : e.status) &&
              o.error("Failed to load categories");
          }
      })(),
      (async () => {
        var e;
        if (b)
          try {
            const e = await r.get(`${n}/api/v1/brands`, {
              headers: { Authorization: `Bearer ${b}` },
            });
            z(e.data || []);
          } catch (t) {
            401 !== (null == (e = t.response) ? void 0 : e.status) &&
              o.error("Failed to load brands");
          }
      })(),
      (async () => {
        var e;
        if (b)
          try {
            const e = await r.get(`${n}/api/v1/suppliers`, {
              headers: { Authorization: `Bearer ${b}` },
            });
            O(e.data || []);
          } catch (t) {
            401 !== (null == (e = t.response) ? void 0 : e.status) &&
              o.error("Failed to load suppliers");
          }
      })());
  }, [p, b]);
  return s.jsx("div", {
                ...
                s.jsxs("div", {
                  ...
                  children: [
                    ...
                    s.jsxs("p", {
                      ...
                      children: [
                        "Store: ",
                        (null == p ? void 0 : p.locationId) || "N/A",
                        " • Staff: ",
                        (null == p ? void 0 : p.name) || "N/A",
                      ],
                    }),
                    !(null == p ? void 0 : p.locationId) &&
                      s.jsx("p", {
                        className:
            ...
            s.jsxs("form", {
              onSubmit: async (e) => {
                ...
                if (
                  ...
                  if (!b || !p)
                    return (
                      o.error("Not authenticated. Please log in again."),
                      void setTimeout(() => {
                  ...
                  try {
                    ...
                    const d = await r.post(
                      `${n}/api/v1/inventory/create-item`,
                      {
                        name: P.name,
                    ...
                    (201 !== d.status && 200 !== d.status) ||
                      (o.success(`Inventory added: ${P.name} (${e} units)`),
                      B({
                        name: "",
                        description: "",
                        quantity: "",
                    ...
                    if (401 === (null == (t = m.response) ? void 0 : t.status))
                      (o.error("Authentication expired. Please log in again."),
                        setTimeout(() => {
                          window.location.href = "/login";
                        }, 2e3));
                    else if (
                      400 === (null == (s = m.response) ? void 0 : s.status)
                    ) {
                      const e =
                        (null ==
                        (l = null == (a = m.response) ? void 0 : a.data)
                          ? void 0
                      ...
                      o.error(
                        (null ==
                        (i = null == (d = m.response) ? void 0 : d.data)
                          ? void 0
                          : i.message) ||
                          m.message ||
                        ...
                        s.jsxs("select", {
                          ...
                          onChange: (e) => {
                            ...
                            B({
                              ...
                              categoryName: (null == t ? void 0 : t.name) || "",
                            });
                          },
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                        ...
                        s.jsxs("select", {
                          ...
                          onChange: (e) => {
                            ...
                            B({
                              ...
                              brandName: (null == t ? void 0 : t.name) || "",
                            });
                          },
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                    ...
                    s.jsxs("div", {
                      children: [
                        ...
                        s.jsx("input", {
                          ...
                          value: P.costCents,
                          onChange: (e) => {
                            const { displayValue: t } = i(e.target.value, !0);
                            B({ ...P, costCents: t });
                          },
                          onBlur: (e) => {
                            const t = d(e.target.value, !0);
                            t && B({ ...P, costCents: t });
                          },
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                ...
                s.jsx("div", {
                  ...
                  children: s.jsxs("p", {
                    ...
                    children: [
                      ...
                      " • Staff: ",
                      (null == p ? void 0 : p.name) || "Current User",
                    ],
                  }),
                }),
                s.jsx("button", {
              ...
              children: [
                ...
                s.jsxs("form", {
                  onSubmit: async (e) => {
                    ...
                    const a = parseFloat(q.delta);
                    if (isNaN(a) || 0 === a)
                      o.error("Please enter a valid quantity adjustment");
                    else
                      try {
                        (await r.post(
                          `${n}/api/v1/inventory/adjust`,
                          {
                          ...
                          o.success(
                            `Inventory adjusted by ${a > 0 ? "+" : ""}${a} units`,
                          ),
                          C(!1),
                          $(null),
                          A({
                        ...
                        o.error(
                          (null ==
                          (s = null == (t = l.response) ? void 0 : t.data)
                            ? void 0
                            : s.message) || "Failed to adjust inventory",
                        );
                      }
                  },
                  className: "space-y-4",
