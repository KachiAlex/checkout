...
import { T as n } from "./ThemeToggle-Cx4IMCiE.js";
import { r as m } from "./receiptService-BwiAn45e.js";
import { R as c } from "./ReceiptOptionsModal-BI8roP3U.js";
      ...
      if (o) {
        ...
        try {
          ...
          switch (
            ...
            case "analytics":
              e.append("period", C);
              const d = await t.get(`${r}/api/v1/reports/sales-analytics?${e}`);
              T(d.data);
              break;
            case "alerts":
              const i = await t.get(`${r}/api/v1/reports/alerts?${e}`);
              z(i.data);
              break;
            case "fraud":
