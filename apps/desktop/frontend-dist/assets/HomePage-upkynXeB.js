...
import { B as m } from "./BrandMark-HxNEMnER.js";
import { g as d } from "./subscriptionPricingService-CEuaZt0p.js";
function x({ onSuccess: i, onCancel: n }) {
  const o = e(),
    [m, d] = t.useState(!1),
    [x, c] = t.useState("free"),
    [p, h] = t.useState({
  ...
  return s.jsxs("div", {
    ...
    children: [
      ...
      s.jsxs("form", {
        onSubmit: async (e) => {
          var t, s;
          if ((e.preventDefault(), d(!0), !p.companyName.trim()))
            return (a.error("Company name is required"), void d(!1));
          if (!p.companySlug.trim())
            return (a.error("Company slug is required"), void d(!1));
          if (!p.adminName.trim())
            return (a.error("Admin name is required"), void d(!1));
          if (!p.adminEmail.trim() || !p.adminEmail.includes("@"))
            return (a.error("Valid admin email is required"), void d(!1));
          if (!p.adminPassword || p.adminPassword.length < 6)
            return (
              a.error("Password must be at least 6 characters"),
              void d(!1)
            );
          if (p.adminPassword !== p.confirmPassword)
            return (a.error("Passwords do not match"), void d(!1));
          try {
            const e = await r.post(`${l}/api/v1/platform/register`, {
              companyName: p.companyName.trim(),
              companySlug: p.companySlug.trim().toLowerCase(),
              adminName: p.adminName.trim(),
              adminEmail: p.adminEmail.trim().toLowerCase(),
              adminPassword: p.adminPassword,
              plan: "free" === x ? void 0 : x,
            });
            if (e.data.success) {
              ...
              (a.success(
                ...
                i ? i() : o(`/${e.data.tenant.slug}/login`));
            }
          } catch (n) {
            const e =
            ...
            children: [
              ...
              s.jsx("input", {
                ...
                onChange: (e) => {
                  ...
                  h((e) => ({ ...e, companyName: t, companySlug: f(t) }));
                },
              ...
              s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx("input", {
                    ...
                    value: p.companySlug,
                    onChange: (e) =>
                      h((t) => ({ ...t, companySlug: f(e.target.value) })),
                    placeholder: "acme-retail",
          ...
          s.jsxs("div", {
            children: [
              ...
              s.jsx("input", {
                ...
                value: p.adminName,
                onChange: (e) =>
                  h((t) => ({ ...t, adminName: e.target.value })),
          ...
          s.jsxs("div", {
            children: [
              ...
              s.jsx("input", {
                ...
                value: p.adminEmail,
                onChange: (e) =>
                  h((t) => ({ ...t, adminEmail: e.target.value })),
          ...
          s.jsxs("div", {
            children: [
              ...
              s.jsx("input", {
                ...
                onChange: (e) =>
                  h((t) => ({ ...t, adminPassword: e.target.value })),
          ...
          s.jsxs("div", {
            children: [
              ...
              s.jsx("input", {
                ...
                onChange: (e) =>
                  h((t) => ({ ...t, confirmPassword: e.target.value })),
...
function b() {
  ...
  const j = (e) => (0 === e ? "$0.00" : `$${(e / 100).toFixed(2)}`),
    w = (e) => (0 === e ? "Unlimited" : e.toString());
  return s.jsxs("div", {
    className:
    ...
    children: [
      ...
      s.jsxs("main", {
        ...
        children: [
          s.jsxs("section", {
            className:
              "mx-auto flex w-full max-w-6xl flex-col gap-8 sm:gap-12 px-3 sm:px-4 lg:px-6 pb-12 sm:pb-16 lg:pb-24 pt-6 sm:pt-8 lg:pt-10 md:flex-row md:items-center",
            children: [
              s.jsxs("div", {
                className: "md:w-7/12",
                children: [
                  s.jsxs("span", {
                    className:
                      "inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-sky-400/40 bg-sky-400/10 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-sky-200",
                    children: [
                      "POS for scale",
                      s.jsx("span", {
                  ...
                  s.jsx("h1", {
                    className:
                      "mt-4 sm:mt-6 text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-semibold tracking-tight text-white",
                    children:
                      "Checkout is the modern POS for growing retail platforms.",
                  }),
                  s.jsx("p", {
                    className:
                      "mt-4 sm:mt-5 text-sm sm:text-base lg:text-lg text-slate-300",
                    children:
                      "Launch branded checkout experiences in hours, not months. Checkout brings scanners, inventory, analytics, and tenant licensing into one glassmorphism-inspired interface your teams love using.",
                  }),
                  s.jsxs("div", {
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          s.jsxs(n, {
                            to: "/login",
                            className:
                              "inline-flex items-center justify-center gap-2 rounded-full border border-white/20 px-5 sm:px-7 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-white transition hover:border-white/40 touch-manipulation",
                            children: [
                              s.jsx("span", {
                                className: "text-base sm:text-lg",
                                children: "🔐",
                          ...
                          s.jsx(n, {
                            to: "/get-app",
                            className:
                              "inline-flex items-center justify-center gap-2 rounded-full border border-emerald-400/60 bg-emerald-400/20 px-5 sm:px-7 py-2.5 sm:py-3 text-sm sm:text-base font-semibold text-emerald-100 shadow-[0_20px_50px_-28px_rgba(16,185,129,0.55)] transition hover:border-emerald-400/80 hover:bg-emerald-400/30 touch-manipulation",
                  ...
                  s.jsx("div", {
                    ...
                    children: p.map((e) =>
                      s.jsxs(
                        ...
                        {
                          className:
                            "rounded-xl sm:rounded-2xl border border-white/10 bg-white/5 px-3 sm:px-5 py-3 sm:py-4 text-center shadow-[inset_0_1px_0_rgba(255,255,255,0.12)]",
                          children: [
                            s.jsx("p", {
                              className:
                            ...
                            s.jsx("p", {
                              className:
                                "text-[10px] sm:text-xs uppercase tracking-[0.35em] text-slate-400 mt-1",
                              children: e.label,
                            }),
                          ],
                        },
              ...
              s.jsx("div", {
                ...
                children: s.jsx("div", {
                  className:
                    "rounded-2xl sm:rounded-[32px] border border-white/10 bg-white/5 p-4 sm:p-6 shadow-[0_40px_90px_-45px_rgba(56,189,248,0.65)] backdrop-blur-xl",
                  children: s.jsxs("div", {
                    className:
                      "rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-900/60 p-4 sm:p-5",
                    children: [
                      s.jsx("p", {
                        className:
                          "text-[10px] sm:text-xs uppercase tracking-[0.4em] text-slate-400",
                        children: "Live dashboard preview",
                      }),
                      s.jsx("h2", {
                        className:
                          "mt-3 sm:mt-4 text-lg sm:text-xl font-semibold text-white",
                        children: "Everything operators need in one pane",
                      }),
                      s.jsxs("ul", {
                        className:
                          "mt-4 sm:mt-6 space-y-3 sm:space-y-4 text-xs sm:text-sm text-slate-300",
                        children: [
                          s.jsxs("li", {
          ...
          s.jsx("section", {
            id: "features",
            className: "bg-white/5 py-12 sm:py-16 lg:py-20 backdrop-blur-xl",
            children: s.jsxs("div", {
              className:
                "mx-auto flex w-full max-w-6xl flex-col gap-8 sm:gap-12 px-3 sm:px-4 lg:px-6 md:flex-row",
              children: [
                s.jsxs("div", {
                  className: "md:w-5/12",
                  children: [
                    s.jsx("p", {
                      ...
                      children: "Why Checkout",
                    }),
                    s.jsx("h2", {
                      className:
                        "mt-3 sm:mt-4 text-2xl sm:text-3xl font-semibold text-white",
                      children: "Built for operators, embraced by crews",
                    }),
                    s.jsx("p", {
                      className:
                        "mt-3 sm:mt-4 text-sm sm:text-base text-slate-300",
                      children:
                        "Checkout takes the friction out of multi-location retail. Turn on QR-based pop-ups, manage gift cards, and sync devices without calling IT.",
                    }),
                    s.jsxs("div", {
                      ...
                      children: [
                        s.jsx("span", {
                          className:
                            "theme-chip rounded-full border border-white/10 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-slate-200",
                          children: "WebUSB / Web Bluetooth",
                        }),
                        s.jsx("span", {
                          className:
                            "theme-chip rounded-full border border-white/10 px-3 sm:px-4 py-1 text-[10px] sm:text-xs font-semibold uppercase tracking-[0.3em] text-slate-200",
                ...
                s.jsx("div", {
                  className: "grid flex-1 gap-4 sm:gap-6 sm:grid-cols-2",
                  children: c.map((e) =>
                    s.jsxs(
                      "div",
                      {
                        className:
                          "group rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-950/60 p-4 sm:p-6 transition hover:border-white/30 hover:bg-slate-900/60",
                        children: [
                          s.jsx("span", {
          ...
          s.jsx("section", {
            ...
            children: s.jsx("div", {
              ...
              children: s.jsxs("div", {
                className:
                  "rounded-2xl sm:rounded-[32px] border border-white/10 bg-gradient-to-br from-white/0 via-white/5 to-white/10 p-6 sm:p-8 lg:p-10 shadow-[0_40px_120px_-50px_rgba(14,165,233,0.6)] backdrop-blur-2xl",
                children: [
                  s.jsx("div", {
                    className: "grid gap-4 sm:gap-6 lg:gap-8 md:grid-cols-2",
                    children: h.map((e) =>
                      s.jsxs(
                        "div",
                        {
                          className:
                            "rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-950/60 p-4 sm:p-6",
                          children: [
                            s.jsx("h3", {
                              className:
                            ...
                            s.jsx("p", {
                              className:
                                "mt-2 sm:mt-3 text-xs sm:text-sm text-slate-300",
                              children: e.body,
                            }),
                          ],
                        },
                  ...
                  s.jsxs("div", {
                    className:
                      "mt-6 sm:mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 sm:gap-6 rounded-2xl sm:rounded-3xl border border-white/10 bg-slate-950/70 px-4 sm:px-6 py-4 sm:py-5 text-xs sm:text-sm text-slate-300",
                    children: [
                      s.jsx("p", {
                        className: "flex-1",
                        children:
                          "Checkout integrates with Clover, Stripe Terminal, Square, and on-prem fiscal printers. Prefer your own? Use our device SDK.",
                      }),
                      s.jsx(n, {
                        to: "/login",
                        className:
                          "rounded-full border border-white/30 px-4 sm:px-5 py-2 text-xs sm:text-sm font-semibold text-white transition hover:border-white/60 touch-manipulation whitespace-nowrap",
                        children: "View operator console →",
                      }),
                    ],
                  }),
                ],
                ...
                s.jsxs("div", {
                  ...
                  children: [
                    ...
                    s.jsx("h2", {
                      className:
                        "mt-3 sm:mt-4 text-2xl sm:text-3xl font-semibold text-white",
                      children: "Growing brands trust Checkout to run retail",
                    }),
                  ],
                }),
                s.jsx("div", {
                        ...
                        children: [
                          ...
                          s.jsxs("div", {
                            ...
                            children: [
                              s.jsx("p", {
                                className:
                                  "font-semibold text-sm sm:text-base text-slate-200",
                                children: e.name,
                              }),
                              s.jsx("p", {
                        ...
                        children: s.jsxs("div", {
                          ...
                          children: [
                            ...
                            s.jsxs("p", {
                              ...
                              children: [l.free.durationDays, " day trial"],
                            }),
                            s.jsx("div", {
                                      ...
                                      s.jsxs("div", {
                                        children: [
                                          ...
                                          s.jsx("p", {
                                            className:
                                              "text-2xl sm:text-3xl font-semibold text-white",
                                            children: j(l.starter.priceCents),
                                          }),
                                        ],
                                      }),
                                      s.jsxs("div", {
                                      ...
                                      children: [
                                        ...
                                        s.jsx("p", {
                                          className:
                                            "text-2xl sm:text-3xl font-semibold text-white",
                                          children:
                                            l.enterprise.priceCents > 0
                                              ? j(l.enterprise.priceCents)
                                              : "Custom",
                                        }),
                                      ],
                                    }),
                                      ...
                                      s.jsxs("div", {
                                        children: [
                                          ...
                                          s.jsx("p", {
                                            className:
                                              "text-2xl sm:text-3xl font-semibold text-white",
                                            children: j(l.lifetime.priceCents),
                                          }),
                                        ],
                                      }),
                                      s.jsxs("div", {
                                        children: [
                                          ...
                                          s.jsx("p", {
                                            className:
                                              "text-lg sm:text-xl font-semibold text-white",
                                            children: w(l.lifetime.locations),
                                          }),
                                        ],
                                      }),
                                      s.jsxs("div", {
          ...
          s.jsx("section", {
            ...
            children: s.jsxs("div", {
              className:
                "mx-auto w-full max-w-4xl rounded-[32px] border border-white/10 bg-gradient-to-br from-emerald-400/20 via-sky-500/10 to-white/10 p-10 text-center shadow-[0_45px_120px_-60px_rgba(56,189,248,0.6)] backdrop-blur-2xl",
              children: [
                s.jsx("p", {
                  className:
                    "text-xs uppercase tracking-[0.4em] text-emerald-200",
                  children: "Ready to modernise your POS?",
                }),
                s.jsx("h2", {
                  className: "mt-4 text-3xl font-semibold text-white",
                  children: "Launch your next retail experience on Checkout",
                }),
                s.jsx("p", {
                  className: "mt-4 text-slate-200",
                  children:
                    "Start with a single location or roll out a full franchise network. Checkout gives you the foundation—device sync, inventory, reporting, and tenant billing—to scale without friction.",
                }),
                s.jsxs("div", {
                  className:
                    "mt-7 flex flex-col items-center justify-center gap-4 sm:flex-row",
                  children: [
                    s.jsx(n, {
                      to: "/login",
                      className:
                        "inline-flex items-center justify-center rounded-full bg-white px-6 py-3 text-sm font-semibold text-slate-900 shadow-lg shadow-white/30 transition hover:shadow-white/45",
                      children: "Launch console",
                    }),
                    s.jsx("a", {
                      ...
                      rel: "noreferrer",
                      className:
                        "inline-flex items-center justify-center gap-2 rounded-full border border-white/40 px-6 py-3 text-sm font-semibold text-white transition hover:border-white/60",
                      children: "Schedule a guided tour →",
                    }),
                  ],
                }),
              ],
        ...
        s.jsx("div", {
          ...
          children: s.jsxs("div", {
            ...
            children: [
              ...
              s.jsx(x, { onSuccess: () => r(!1), onCancel: () => r(!1) }),
            ],
          }),
        }),
      s.jsx("footer", {
        ...
        children: s.jsxs("div", {
          className:
            "mx-auto flex w-full max-w-6xl flex-col gap-6 px-6 text-sm text-slate-400 md:flex-row md:items-center md:justify-between",
          children: [
            s.jsxs("div", {
              children: [
                s.jsx("p", {
            ...
            s.jsxs("div", {
              ...
              children: [
                ...
                s.jsx("a", {
                  href: "https://checkout-77d99.web.app/login",
                  className: "hover:text-white",
