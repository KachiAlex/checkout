...
import { T as d } from "./ThemeToggle-TO1YIz9m.js";
import { h as c, S as l, b as u, f as m, p } from "./ScannerInput-Ci9-hhYG.js";
import { A as x } from "./AlertBanner-oDZgr0W8.js";
import { f as h } from "./format-BJFo2Mkz.js";
  ...
  try {
    const t = await (async function (t) {
      ...
      try {
        ...
        if (
          1 === (null == (r = s.data) ? void 0 : r.status) &&
          (null == (a = s.data) ? void 0 : a.product)
        ) {
          const e = s.data.product;
          return {
            name:
              e.product_name ||
              e.product_name_en ||
            ...
            category:
              e.categories ||
              (null == (n = e.categories_tags) ? void 0 : n[0]) ||
              void 0,
  ...
  try {
    const t = await (async function (t) {
      ...
      try {
        ...
        if (
          "OK" === (null == (r = a.data) ? void 0 : r.code) &&
          (null == (s = null == (n = a.data) ? void 0 : n.items)
            ? void 0
            : s.length) > 0
        ) {
          const e = a.data.items[0];
          return {
            name: e.title || e.description || "Unknown Product",
            description: e.description || void 0,
            brand: e.brand || void 0,
            category: e.category || void 0,
            image: (null == (o = e.images) ? void 0 : o[0]) || void 0,
  ...
  try {
    const t = await (async function (t) {
      ...
      try {
        ...
        if (
          (null == (n = null == (r = a.data) ? void 0 : r.products)
            ? void 0
            : n.length) > 0
        ) {
          const e = a.data.products[0];
          return {
            name: e.product_name || e.title || "Unknown Product",
            description: e.description || void 0,
            brand: e.brand || void 0,
            category: e.category || void 0,
            image: (null == (s = e.images) ? void 0 : s[0]) || void 0,
            price: (
              null == (i = null == (o = e.stores) ? void 0 : o[0])
                ? void 0
                : i.price
            )
        ...
        401 !== (null == (d = a.response) ? void 0 : d.status) &&
          (null == (c = a.response) || c.status);
      }
      return null;
    })(r);
    if (t) return t;
...
function b() {
  const { user: b, logout: g, accessToken: f, tenant: v } = t(),
    [w, N] = r.useState([]),
    [j, C] = r.useState(!1),
    [I, k] = r.useState((null == b ? void 0 : b.locationId) || null),
    [P, q] = r.useState({
      name: "",
      description: "",
      quantity: "",
    ...
    Q = async () => {
      ...
      try {
        const t =
          (
            await e.get(`${s}/api/v1/locations`, {
    ...
    Y = async () => {
      ...
      if (f && b) {
        ...
        try {
          ...
          if (!t) return void N([]);
          k(t);
          const r = await e.get(`${s}/api/v1/inventory/${t}/stock`, {
            headers: { Authorization: `Bearer ${f}` },
          });
          N(r.data || []);
        } catch (n) {
          401 === (null == (t = n.response) ? void 0 : t.status)
            ? o.error("Authentication expired. Please log in again.")
            : o.error(
                (null == (a = null == (r = n.response) ? void 0 : r.data)
                  ? void 0
                  : a.message) || "Failed to load inventory",
              );
        } finally {
          C(!1);
        }
    ...
    r.useEffect(() => {
      b &&
        ...
        (async () => {
          if (f)
            try {
              const t = await e.get(`${s}/api/v1/categories`, {
                headers: { Authorization: `Bearer ${f}` },
              });
              M(t.data || []);
            } catch (t) {}
        ...
        (async () => {
          if (f)
            try {
              const t = await e.get(`${s}/api/v1/brands`, {
                headers: { Authorization: `Bearer ${f}` },
              });
              F(t.data || []);
            } catch (t) {}
        })());
    }, [null == b ? void 0 : b.id, f]),
    r.useEffect(() => {
      const e = () => {
                  ...
                  if (P.name && P.quantity && P.costCents && P.priceCents)
                    if ("new" !== _ || u)
                      if ("new" !== $ || m)
                        if (f && b)
                          try {
                            const t = parseInt(p(P.quantity).toString(), 10),
                              a = Math.round(100 * p(P.costCents)),
                              n = Math.round(100 * p(P.priceCents));
                            if (isNaN(t) || t < 0)
                              return void o.error("Invalid quantity");
                            if (isNaN(a) || a < 0)
                              return void o.error("Invalid cost price");
                            if (isNaN(n) || n < 0)
                              return void o.error("Invalid selling price");
                            const i = "new" === _ ? u : void 0,
                              d = "new" === $ ? m : void 0,
                              c = await e.post(
                                `${s}/api/v1/inventory/create-item`,
                                {
                                  name: P.name,
                            ...
                            if (
                              401 ===
                              (null == (a = x.response) ? void 0 : a.status)
                            )
                              o.error(
                              ...
                              400 ===
                              (null == (n = x.response) ? void 0 : n.status)
                            ) {
                              const e =
                                (null ==
                                (d = null == (i = x.response) ? void 0 : i.data)
                                  ? void 0
                              ...
                              o.error(
                                (null ==
                                (l = null == (c = x.response) ? void 0 : c.data)
                                  ? void 0
                                  : l.message) ||
                                  x.message ||
                        ...
                        else o.error("Not authenticated. Please log in again.");
                      else
                        o.error(
                                  ...
                                  if (l && f) {
                                    ...
                                    try {
                                      const l =
                                          (
                                            await e.get(
                                              `${s}/api/v1/products?query=${encodeURIComponent(t)}`,
                                              {
                                                headers: {
                                                  Authorization: `Bearer ${f}`,
                                                },
                                        ...
                                        x =
                                          l.find((e) => e.barcode === t) ||
                                          l[0];
                                      if (x) {
                                        o.success(`Found product: ${x.name}`);
                                        const l = await Q();
                                        if (l)
                                          try {
                                            const d = (
                                              await e.get(
                                                `${s}/api/v1/inventory/${l}/stock`,
                                                {
                                                  headers: {
                                                    Authorization: `Bearer ${f}`,
                                                  },
                                            ...
                                            d
                                              ? (q({
                                                  ...
                                                  costCents: d.costCents
                                                    ? u(d.costCents / 100)
                                                    : "",
                                                  priceCents: d.salesPriceCents
                                                    ? u(d.salesPriceCents / 100)
                                                    : x.priceCents
                                                      ? u(x.priceCents / 100)
                                                      : "",
                                                  barcode: x.barcode || t,
                                ...
                                onClick: () => {
                                  S((e) => {
                                    ...
                                    return (
                                      q((e) =>
                                        "new" === t
                                          ? ((B.current = e.categoryId),
                                            { ...e, categoryId: "" })
                                          : {
                                              ...e,
                                              categoryId: B.current || "",
                                            },
                                      ),
                                      t
                                    );
