...
import { T as n } from "./ThemeToggle-TO1YIz9m.js";
import { r as m } from "./receiptService-CYsJo9Ta.js";
import { R as c } from "./ReceiptOptionsModal-y0TcW95P.js";
import { f as o } from "./format-BJFo2Mkz.js";
...
function p() {
  var o, p, u, j, b, y, N;
  const { accessToken: f, user: g } = e(),
    [v, w] = s.useState("sales"),
    [k, C] = s.useState(!1),
    [S, M] = s.useState((null == g ? void 0 : g.locationId) || null),
    [P, I] = s.useState([]),
    [L, O] = s.useState({ from: x(), to: x() }),
    [$, T] = s.useState(null),
    [z, A] = s.useState(null),
    [D, V] = s.useState("product"),
    [F, W] = s.useState(null),
    [R, E] = s.useState(null),
    [B, U] = s.useState(null),
    [H, Q] = s.useState(null),
    ...
    fe = 10,
    [ge, ve] = s.useState(!1),
    [we, ke] = s.useState(null),
    [Ce, Se] = s.useState(!1),
    [Me, Pe] = s.useState(null),
    Ie = s.useMemo(() => `${L.from}-${L.to}`, [L.from, L.to]),
    Le = s.useCallback(async () => {
      var e;
      if (f)
        try {
          const s = await t.get(`${r}/api/v1/locations`);
          (I(s.data || []),
            !S &&
              (null == (e = s.data) ? void 0 : e.length) > 0 &&
              M(s.data[0].id));
        } catch (s) {}
    }, [f, S]),
    Oe = s.useCallback(async () => {
      ...
      if (f) {
        ...
        try {
          ...
          switch (
            (S && e.append("location_id", S),
            L.from && e.append("from", L.from),
            L.to && e.append("to", L.to),
            v)
          ) {
            case "sales":
              (e.append("limit", fe.toString()),
                e.append("offset", ((ee - 1) * fe).toString()));
              const s = await t.get(`${r}/api/v1/reports/sales?${e}`);
              T(s.data);
              break;
            case "top-sellers":
              e.append("limit", "20");
              const a = await t.get(`${r}/api/v1/reports/top-sellers?${e}`);
              A(a.data);
              const l = await t.get(
            ...
            case "analytics":
              ...
              const i = await t.get(`${r}/api/v1/reports/sales-analytics?${e}`);
              W(i.data);
              break;
            case "alerts":
              const d = await t.get(`${r}/api/v1/reports/alerts?${e}`);
              E(d.data);
              break;
            case "fraud":
              const n = await t.get(`${r}/api/v1/reports/fraud-detection?${e}`);
              U(n.data);
              break;
            case "expiry":
              const m = await t.get(
            ...
            case "purchase-orders":
              const h = await t.get(`${r}/api/v1/purchase-orders`);
              Z(h.data || []);
          }
        } catch (s) {
          401 !== (null == (e = s.response) ? void 0 : e.status) &&
            a.error(`Failed to load ${v} report`);
        } finally {
          C(!1);
        }
      }
    }, [f, v, S, L.from, L.to, ee, fe, te]),
    $e = s.useCallback((e) => `₦${e.toFixed(2)}`, []),
    Te = s.useCallback((e) => `₦${(e / 100).toFixed(2)}`, []),
    ze = s.useCallback((e) => {
      (ke(e), ve(!0));
    }, []),
    Ae = s.useCallback(async (e) => {
      try {
  ...
  return (
    ...
    s.useEffect(() => {
      (se(1), re(1), le(1), de(1), me(1), oe(1), he(1), ue(1), be(1), Ne(1));
    }, [v, Ie, S]),
    s.useEffect(() => {
      f && Oe();
    }, [f, v, S, Ie, Oe]),
      ...
      children: [
        ...
        l.jsxs("main", {
          ...
          children: [
                  ...
                  l.jsxs("div", {
                    ...
                    children: [
                      ...
                      l.jsx("input", {
                        type: "date",
                        value: L.from,
                        onChange: (e) => O({ ...L, from: e.target.value }),
                        className:
                          "w-full theme-surface rounded-lg border theme-border px-3 py-2.5 text-sm theme-text-primary bg-transparent focus:ring-2 focus:ring-sky-400/50 focus:border-sky-400 transition",
                      }),
                    ],
                  ...
                  l.jsxs("div", {
                    ...
                    children: [
                      ...
                      l.jsx("input", {
                        type: "date",
                        value: L.to,
                        onChange: (e) => O({ ...L, to: e.target.value }),
                        className:
                          "w-full theme-surface rounded-lg border theme-border px-3 py-2.5 text-sm theme-text-primary bg-transparent focus:ring-2 focus:ring-sky-400/50 focus:border-sky-400 transition",
                      }),
                    ],
            ...
            l.jsx("div", {
              className:
                "mb-4 sm:mb-6 overflow-x-auto -mx-3 sm:mx-0 px-3 sm:px-0",
              children: l.jsx("div", {
                className:
                  "flex gap-2 sm:gap-3 border-b theme-border min-w-max sm:min-w-0",
                children: Re.map((e) =>
                  l.jsxs(
                    "button",
                    {
                      onClick: () => w(e.id),
                      className:
                        "flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2.5 sm:py-2 text-xs sm:text-sm font-medium transition border-b-2 whitespace-nowrap " +
                        (v === e.id
                      ...
                      children: [
                        ...
                        l.jsx("span", {
                          className: "hidden min-[400px]:inline sm:hidden",
                      ...
                      "top-sellers" === v &&
                        ...
                        l.jsxs("div", {
                          ...
                          children: [
                            ...
                            "product" === D
                              ? z.topSellers && z.topSellers.length > 0
                                ? (() => {
                                    const e = Fe(z.topSellers, te, fe);
                              ...
                              : K &&
                                  K.staffPerformance &&
                                  K.staffPerformance.length > 0
                                ? (() => {
                                    const e = K.staffPerformance
                                        .map((e) => {
                                          var s, t;
                                          return {
                                            userId: e.userId,
                                  ...
                                  l.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      l.jsx("p", {
                                        className:
                                          "text-2xl font-bold theme-text-primary",
                                        children: $e(F.averageOrderValue),
                                      }),
                                    ],
                                  }),
                                ],
                                      ...
                                      l.jsx("div", {
                                        ...
                                        children: e.items.map((e, s) => {
                                          ...
                                          return l.jsxs(
                                            "div",
                                            {
                                              className: `flex items-center justify-between p-5 rounded-xl border-2 ${We(e.severity, e.type)} hover:scale-[1.02] transition-all ${r && t ? "ring-2 ring-red-500/50" : ""}`,
                                              children: [
                                                l.jsxs("div", {
                                                  className:
                                                    "flex items-center gap-4 flex-1 min-w-0",
                      ...
                      "fraud" === v &&
                        ...
                        l.jsxs("div", {
                          ...
                          children: [
                            ...
                            B.fraudAlerts && B.fraudAlerts.length > 0
                              ? (() => {
                                  const e = Fe(B.fraudAlerts, xe, fe);
                                  return l.jsxs(l.Fragment, {
                                    children: [
                                      l.jsx("div", {
                                        className: "space-y-2",
                                        children: e.items.map((e, s) =>
                                          l.jsxs(
                                            "div",
                                            {
                                              className: `flex items-center justify-between p-4 rounded-lg border ${We(e.severity)} hover:opacity-80 transition`,
                                              children: [
                                                l.jsxs("div", {
                                                  className:
                                                    "flex items-center gap-4 flex-1 min-w-0",
                      ...
                      "expiry" === v &&
                        ...
                        l.jsxs("div", {
                          ...
                          children: [
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold theme-text-primary",
                                      children: H.totalExpiringSoon || 0,
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
                            ...
                            (() => {
                              const e = [
                                  ...(H.expiringSoon || []).map((e) => ({
                                    ...e,
                                    status: "expiring",
                                  })),
                                  ...(H.expiredItems || []).map((e) => ({
                                    ...e,
                                    status: "expired",
                                  })),
                                ],
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold theme-text-primary",
                                      children: q.totalDiscrepancies || 0,
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold text-yellow-400",
                                      children: q.warningCount || 0,
                                    }),
                                  ],
                                }),
                              ],
                            }),
                            q.shrinkageAlerts && q.shrinkageAlerts.length > 0
                              ? (() => {
                                  const e = Fe(q.shrinkageAlerts, je, fe);
                                  return l.jsxs(l.Fragment, {
                                    children: [
                                      l.jsx("div", {
                                        className: "space-y-2",
                              ...
                              : l.jsx("p", {
                                  className:
                                    "theme-text-secondary text-center py-8",
                                  children:
                                    q.message || "No discrepancies detected",
                                }),
                          ],
                        }),
                      "staff" === v &&
                            ...
                            G.inventorizedProducts &&
                              l.jsxs("div", {
                                children: [
                                  ...
                                  G.inventorizedProducts.products &&
                                    G.inventorizedProducts.products.length >
                                      0 &&
                                    (() => {
                                      const e = Fe(
                                        G.inventorizedProducts.products,
                          ...
                          children: [
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("span", {
                                  className: `px-3 py-1 rounded-full text-xs font-medium ${We(Me.severity)}`,
                                  children: Me.severity.toUpperCase(),
                                }),
                              ],
                            }),
                          ],
                              ...
                              ? l.jsxs("div", {
                                  children: [
                                    ...
                                    l.jsxs("p", {
                                      className:
                                        "font-medium theme-text-primary",
                                      children: [Me.daysExpired, " days ago"],
                                    }),
                                  ],
                                })
                              : l.jsxs("div", {
                                  children: [
                                    ...
                                    l.jsxs("p", {
                                      className:
                                        "font-medium theme-text-primary",
                                      children: [Me.daysUntilExpiry, " days"],
                                    }),
                                  ],
                                }),
                            l.jsxs("div", {
                          ...
                          children: [
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("p", {
                                  className: "font-medium theme-text-primary",
                                  children: $e(Me.averageOrderValue),
                                }),
                              ],
                            }),
                          ],
                                      ...
                                      className:
                                        ...
                                        ("received" === Me.status
                                          ...
                                          : "approved" === Me.status
                                            ? "bg-blue-500/20 text-blue-400 border border-blue-500/50"
                                            : "bg-yellow-500/20 text-yellow-400 border border-yellow-500/50"),
                                      children: Me.status.toUpperCase(),
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
