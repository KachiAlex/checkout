import { d as e, p as t, e as a, A as n, a as d } from "./index-CcrCVdax.js";
const c = e()(
  t(
    (e, t) => ({
      devices: [],
      ...
      addDevice: (t) => {
        const a =
          ...
          c = { ...t, id: a, connectedAt: n, lastUsedAt: d };
        return (
          e((e) => {
...
async function s(e, t) {
  const d = await a.post(`${n}/api/v1/devices/register`, e, {
    headers: { "X-Tenant-Slug": r() },
  });
  return i(d.data?.data ?? d.data ?? d.data, t);
}
async function o(e) {
  return (
...
function v(e, t) {
  switch (e) {
    case "usb":
      return t?.name
        ? t.name
        : t?.vendorId && t?.productId
          ? `USB Scanner (${t.vendorId}:${t.productId})`
          : "USB Scanner";
    case "bluetooth":
      return t?.name || "Bluetooth Scanner";
    case "camera":
...
async function l(e, t, a, n = !1) {
  ...
  return s(d, d.identifier);
}
async function I(e, t, a) {
  const n = await (async function () {
      if ("undefined" == typeof navigator) return null;
      const e = navigator;
      if (!e.usb) return null;
      try {
        const t = await e.usb.getDevices();
        if (0 === t.length) return null;
        const a = t[0];
        return {
          vendorId: a.vendorId?.toString(16).padStart(4, "0"),
          productId: a.productId?.toString(16).padStart(4, "0"),
          deviceName: a.productName || "USB Scanner",
        };
      } catch (t) {
        return null;
      }
    ...
    d =
      n?.vendorId && n?.productId
        ? `${n.vendorId}:${n.productId}`.toLowerCase()
        : `usb_${Date.now()}`;
  return s(
    {
      identifier: d,
      ...
      registeredById: t,
      metadata: {
        manufacturer: n?.deviceName?.split(" ")[0],
        deviceName: n?.deviceName || "USB HID Scanner (Keyboard Mode)",
...
async function m(e, t, a) {
  ...
  const n = {
    ...
    metadata: { manufacturer: d.name?.split(" ")[0], model: d.name },
  };
  var d;
...
export { m as a, o as f, I as r, p as s, c as u };
