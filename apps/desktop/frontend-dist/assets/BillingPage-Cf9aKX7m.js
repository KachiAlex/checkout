...
import { T as a } from "./ThemeToggle-TO1YIz9m.js";
import { B as o } from "./BrandMark-HxNEMnER.js";
import { g as d, u as c } from "./subscriptionPricingService-CEuaZt0p.js";
import { f as u } from "./format-BJFo2Mkz.js";
async function m(t) {
  const { data: i } = await e.get(`${s}/api/v1/promo-discounts`, {
    headers: { Authorization: `Bearer ${t}` },
  });
  return i;
}
function x() {
  var x, p, h, f, b, v, g, y, j, N, w, k, C, P, S, D, T, V, A;
  const { user: $, logout: F } = t((e) => ({ user: e.user, logout: e.logout })),
    [U, M] = i.useState(null),
    [L, I] = i.useState(!1),
    [z, q] = i.useState(!1),
    [B, O] = i.useState({}),
  ...
  if (
    (i.useEffect(() => {
      if (!(null == $ ? void 0 : $.isPlatformAdmin)) return;
      (async () => {
        var e, s, i, r, l, a;
        (I(!0), K(!0));
        try {
          ...
          (M(l),
            ...
            R({
              starter:
                ((null == (e = l.starter) ? void 0 : e.priceCents) ?? 0) / 100,
              professional:
                ((null == (s = l.professional) ? void 0 : s.priceCents) ?? 0) /
                100,
              enterprise:
                ((null == (i = l.enterprise) ? void 0 : i.priceCents) ?? 0) /
                100,
              lifetime:
                ((null == (r = l.lifetime) ? void 0 : r.priceCents) ?? 0) / 100,
            }));
          const { accessToken: n } = t.getState();
          if (n) {
            const e = await m(n);
            H(e);
          }
          ...
          n.error(
            (null ==
            (a =
              null == (l = null == o ? void 0 : o.response) ? void 0 : l.data)
              ? void 0
              : a.message) || "Unable to load billing data",
          );
        } finally {
          (I(!1), K(!1));
        }
      })();
    }, [null == $ ? void 0 : $.isPlatformAdmin]),
    !(null == $ ? void 0 : $.isPlatformAdmin))
  )
    return r.jsx(l, { to: "/login", replace: !0 });
  const te = async () => {
      var i, r;
      const { accessToken: l } = t.getState();
      if (l)
        if (Z.code && Z.name && Z.validFrom && Z.validUntil)
          if (
            "percentage" === Z.discountType &&
            (Z.discountValue < 0 || Z.discountValue > 100)
          )
            n.error("Percentage discount must be between 0 and 100");
          else
            try {
              const t = {
                ...Z,
                discountValue:
                  "fixed" === Z.discountType && void 0 !== ee.discountValue
                    ? Math.round(100 * ee.discountValue)
                    : Z.discountValue,
                minPurchaseCents: ee.minPurchase
                  ? Math.round(100 * ee.minPurchase)
                  : void 0,
                maxDiscountCents: ee.maxDiscount
                  ? Math.round(100 * ee.maxDiscount)
                  : void 0,
              };
              X
                ? (await (async function (t, i, r) {
                    const { data: l } = await e.put(
                  ...
                  n.success("Promo discount updated"))
                : (await (async function (t, i) {
                  ...
                  n.success("Promo discount created"));
              const i = await m(l);
              (H(i), W(!1));
            } catch (a) {
              n.error(
                (null ==
                (r =
                  null == (i = null == a ? void 0 : a.response)
                    ? void 0
                    : i.data)
                  ? void 0
                  : r.error) || "Failed to save promo discount",
              );
            }
        else n.error("Please fill in all required fields");
      ...
      if (a)
        try {
          (await (async function (t, i) {
            ...
            n.success("Promo discount deleted"));
          const t = await m(a);
          H(t);
        } catch (o) {
          n.error(
            (null ==
            (l =
              null == (r = null == o ? void 0 : o.response) ? void 0 : r.data)
              ? void 0
              : l.error) || "Failed to delete promo discount",
          );
        }
      else n.error("Not authenticated");
    };
                  ...
                  r.jsx("button", {
                    onClick: async () => {
                      var e,
                        ...
                        w,
                        k;
                      const { accessToken: C } = t.getState();
                      if (C)
                        if (U) {
                          q(!0);
                          try {
                            const t = {
                                ...
                                professional: {
                                  ...U.professional,
                                  priceCents: Math.round(
                                    100 * (E.professional ?? 0),
                                  ),
                                  locations:
                                    (null == (l = B.professional)
                                      ? void 0
                                      : l.locations) ??
                                    (null == (a = U.professional)
                                      ? void 0
                                      : a.locations) ??
                                    5,
                                  users:
                                    (null == (o = B.professional)
                                      ? void 0
                                      : o.users) ??
                                    (null == (d = U.professional)
                                      ? void 0
                                      : d.users) ??
                                    15,
                                },
                            ...
                            (M(w),
                              ...
                              n.success("Pricing updated successfully"));
                          } catch (P) {
                            n.error(
                              (null ==
                              (k =
                                null == (w = null == P ? void 0 : P.response)
                                  ? void 0
                                  : w.data)
                                ? void 0
                                : k.message) || "Unable to update pricing",
                            );
                          } finally {
                            q(!1);
                          }
                        } else n.error("Pricing config not loaded");
                      else n.error("Not authenticated");
                    },
                    disabled: z || L,
                    className:
                    ...
                    children: z ? "Saving..." : "Save Pricing",
                  }),
                ],
              }),
              L
                                ...
                                r.jsxs("div", {
                                  children: [
                                    ...
                                    r.jsx("input", {
                                      ...
                                      min: "1",
                                      value:
                                        (null == (y = B.professional)
                                          ? void 0
                                          : y.locations) ??
                                        (null == (j = U.professional)
                                          ? void 0
                                          : j.locations) ??
                                        5,
                                      onChange: (e) =>
                                ...
                                r.jsxs("div", {
                                  children: [
                                    ...
                                    r.jsx("input", {
                                      ...
                                      min: "1",
                                      value:
                                        (null == (N = B.professional)
                                          ? void 0
                                          : N.users) ??
                                        (null == (w = U.professional)
                                          ? void 0
                                          : w.users) ??
                                        15,
                                      onChange: (e) =>
          ...
          children: r.jsxs("div", {
            ...
            children: [
              ...
              r.jsx("h2", {
                ...
                children: X ? "Edit Promo Discount" : "Create Promo Discount",
              }),
              r.jsxs("form", {
                onSubmit: (e) => {
                  (e.preventDefault(), te());
                  ...
                  r.jsxs("div", {
                    children: [
                      ...
                      r.jsx("textarea", {
                        value: Z.description,
                        onChange: (e) =>
                          _((s) => ({ ...s, description: e.target.value })),
                      ...
                      r.jsxs("div", {
                        children: [
                          ...
                          r.jsx("input", {
                            type: "number",
                            value:
                              "fixed" === Z.discountType &&
                              void 0 !== ee.discountValue
                                ? ee.discountValue
                                : Z.discountValue,
                            onChange: (e) => {
                              const s = parseFloat(e.target.value) || 0;
                              "fixed" === Z.discountType
                                ? se((e) => ({ ...e, discountValue: s }))
                                : _((e) => ({ ...e, discountValue: s }));
                            },
                            min: 0,
                            max: "percentage" === Z.discountType ? 100 : void 0,
                            step: "percentage" === Z.discountType ? 1 : 0.01,
                            className:
                              "theme-surface w-full rounded-xl border px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-sky-400",
                            required: !0,
                          }),
                      ...
                      r.jsxs("div", {
                        children: [
                          ...
                          r.jsx("input", {
                            ...
                            value: Z.validFrom,
                            onChange: (e) =>
                              _((s) => ({ ...s, validFrom: e.target.value })),
                            className:
                              "theme-surface w-full rounded-xl border px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-sky-400",
                            required: !0,
                          }),
                      ...
                      r.jsxs("div", {
                        children: [
                          ...
                          r.jsx("input", {
                            ...
                            value: Z.validUntil,
                            onChange: (e) =>
                              _((s) => ({ ...s, validUntil: e.target.value })),
                            className:
                              "theme-surface w-full rounded-xl border px-4 py-2.5 text-sm outline-none focus:ring-2 focus:ring-sky-400",
                            required: !0,
                          }),
                      ...
                      r.jsxs("div", {
                        ...
                        children: [
                          r.jsx("input", {
                            ...
                            checked: Z.isActive,
                            onChange: (e) =>
                              _((s) => ({ ...s, isActive: e.target.checked })),
                  ...
                  r.jsxs("div", {
                    ...
                    children: [
                      r.jsx("button", {
                        ...
                        children: X ? "Update Promo" : "Create Promo",
                      }),
                      r.jsx("button", {
                        type: "button",
                        onClick: () => W(!1),
