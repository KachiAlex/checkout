...
import { T as d } from "./ThemeToggle-in661Exp.js";
import { g as o, u as c } from "./subscriptionPricingService-2crzxycf.js";
async function m(s) {
...
function h() {
  const { user: h, logout: b } = s((e) => ({ user: e.user, logout: e.logout })),
  ...
  if (
    (a.useEffect(() => {
      ...
      ((async () => {
        ...
        try {
          ...
          i.error(s?.response?.data?.message || "Unable to load tenants");
        } finally {
          N(!1);
        }
      })(),
        (async () => {
          ...
          try {
            ...
            i.error(e?.response?.data?.message || "Unable to load pricing");
          } finally {
            W(!1);
          }
        })());
    ...
    return n.jsx(l, { to: "/login", replace: !0 });
  const ne = a.useMemo(() => {
      if (!C.trim()) return y;
    ...
    le = a.useMemo(
      () => ({
        total: y.length,
        active: y.filter((e) => "active" === e.status).length,
        pending: y.filter((e) => "pending" === e.status).length,
        suspended: y.filter((e) => "suspended" === e.status).length,
      }),
      [y],
    ),
    re = (e) => {
          ...
          if ("lifetime" === t) a.billingCycleEnd = "";
            ...
            const e =
              a.billingCycleStart && "" !== a.billingCycleStart.trim()
                ...
                : O?.billingCycleStart
                  ? new Date(O.billingCycleStart)
                  : new Date();
            ((a.billingCycleStart && "" !== a.billingCycleStart.trim()) ||
              (a.billingCycleStart = e.toISOString().slice(0, 10)),
              (a.billingCycleEnd = ie(e).toISOString().slice(0, 10)));
          } else
            a.billingCycleEnd = O?.billingCycleEnd ? O.billingCycleEnd : "";
        return (
          "billingCycleStart" === e &&
            "annual" === s.plan &&
            (a.billingCycleEnd = t
              ? ie(new Date(t)).toISOString().slice(0, 10)
              : ""),
          a
        );
      });
    ...
    xe = async (s) => {
      ...
      try {
        ...
        i.error(a?.response?.data?.message || "Unable to reset admin PIN");
      } finally {
        D(null);
      }
    },
    ue = async (s) => {
      ...
      try {
        ...
        (f((e) => e.map((e) => (e.id === n.id ? n : e))),
          i.success(`${s.name} suspended`));
      } catch (n) {
        i.error(n?.response?.data?.message || "Unable to suspend tenant");
      } finally {
        D(null);
      }
    },
    pe = async (e) => {
      ...
      try {
        ...
        i.error(t?.response?.data?.message || "Unable to activate tenant");
      } finally {
        D(null);
      }
    },
      ...
      if (
        ...
        try {
          (await (async function (s) {
            ...
            f((e) => e.filter((e) => e.id !== s.id)),
            P((e) => (e?.tenant.id === s.id ? null : e)),
            i.success(`${s.name} deleted`));
        } catch (a) {
          i.error(a?.response?.data?.message || "Unable to delete tenant");
        } finally {
          D(null);
        }
      }
                ...
                n.jsxs("div", {
                  ...
                  children: [
                    ...
                    n.jsx("button", {
                      ...
                      children: X ? "Saving..." : "Save Pricing",
                    }),
                  ],
                }),
              ],
                            ...
                            children: [
                              ...
                              n.jsxs("div", {
                                children: [
                                  ...
                                  n.jsx("input", {
                                    type: "number",
                                    value: ee.professional?.locations ?? 5,
                                    onChange: (e) =>
                                      te((t) => ({
                                        ...t,
                                        professional: {
                            ...
                            children: [
                              ...
                              n.jsxs("div", {
                                children: [
                                  ...
                                  n.jsx("input", {
                                    type: "number",
                                    value: ee.enterprise?.locations ?? 0,
                                    onChange: (e) =>
                                      te((t) => ({
                                        ...t,
                                        enterprise: {
        ...
        n.jsxs("section", {
          ...
          children: [
            ...
            n.jsxs("form", {
              ...
              onSubmit: async (s) => {
                if ((s.preventDefault(), E.name.trim() && E.slug.trim()))
                  if (E.adminEmail.trim())
                    if (
                      "scheduled" !== E.billingStartMode ||
                      E.billingCycleStart
                    ) {
                      w(!0);
                      try {
                        const s = "immediate" === E.billingStartMode,
                          n =
                            s || E.billingCycleStart
                              ? s
                                ? new Date()
                                : new Date(E.billingCycleStart)
                              : void 0,
                          l = {
                            name: E.name.trim(),
                            ...
                            seatLimit: E.seatLimit
                              ? Number(E.seatLimit)
                              : void 0,
                            adminEmail: E.adminEmail.trim().toLowerCase(),
                            adminName: E.adminName.trim() || void 0,
                            ...
                            billingCycleEnd:
                              "lifetime" === E.plan
                                ...
                                : "annual" === E.plan && n
                                  ? ie(n).toISOString()
                                  : E.billingCycleEnd
                                    ? new Date(E.billingCycleEnd).toISOString()
                                    : void 0,
                          },
                        ...
                        if (s)
                          try {
                            ((d = await m(r.tenant.id)),
                              i.success(`${d.name} activated immediately`, {
                                duration: 6e3,
                              }));
                          } catch (a) {
                            i.error(
                              a?.response?.data?.message ||
                                `${r.tenant.name} created, but activation failed`,
                            );
                          }
                        (f((e) => [d, ...e]),
                          P({ tenant: d, admin: r.admin }),
                          i.success(
                            `Tenant ${d.name} created. Admin account: ${r.admin.email} | Temporary PIN: ${r.admin.temporaryPin}`,
                            { duration: 1e4 },
                          ),
                          $({
                            name: "",
              ...
              children: [
                        ...
                        n.jsx("button", {
                          ...
                          onClick: () =>
                            $((e) => ({
                              ...
                              billingCycleEnd:
                                "annual" === e.plan
                                  ? ie(new Date()).toISOString().slice(0, 10)
                                  : e.billingCycleEnd,
                            })),
                        ...
                        onChange: (e) =>
                          $((t) => {
                            ...
                            return {
                              ...
                              billingCycleEnd:
                                "annual" === t.plan && s
                                  ? ie(new Date(s)).toISOString().slice(0, 10)
                                  : "annual" === t.plan
                                    ? ""
                                    : t.billingCycleEnd,
                            };
                ...
                n.jsx("div", {
                  ...
                  children: n.jsx("button", {
                    ...
                    children: v ? "Provisioning…" : "Provision tenant",
                  }),
                }),
              ],
            }),
                                    ...
                                    children: n.jsxs("div", {
                                      ...
                                      children: [
                                        n.jsx("button", {
                                          ...
                                          onClick: () =>
                                            ((e) => {
                                              const t = re(e.billingCycleStart),
                                                s = {
                                                  plan: e.plan,
                                                  seatLimit:
                                                    void 0 !== e.seatLimit
                                        ...
                                        "active" !== e.status &&
                                          ...
                                          n.jsx("button", {
                                            ...
                                            className: me,
                                            onClick: () => pe(e),
                                            disabled: ce(`${e.id}:activate`),
                                            children: ce(`${e.id}:activate`)
                                              ? "Activating…"
                                              : "Activate now",
                                          }),
                                        n.jsx("button", {
                                          ...
                                          className: me,
                                          onClick: () => xe(e),
                                          disabled: ce(`${e.id}:reset`),
                                          children: ce(`${e.id}:reset`)
                                            ? "Resetting…"
                                            : "Reset PIN",
                                        }),
                                        "suspended" === e.status
                                          ...
                                          : n.jsx("button", {
                                              ...
                                              className: me,
                                              onClick: () => ue(e),
                                              disabled: ce(`${e.id}:suspend`),
                                              children: ce(`${e.id}:suspend`)
                                                ? "Suspending…"
                                                : "Suspend",
                                            }),
                                        n.jsx("button", {
                                          ...
                                          onClick: () => he(e),
                                          disabled: ce(`${e.id}:delete`),
                                          children: ce(`${e.id}:delete`)
                                            ? "Deleting…"
                                            : "Delete",
                                        }),
                                      ],
            ...
            children: n.jsxs("div", {
              ...
              children: [
                ...
                n.jsxs("form", {
                  className: "mt-6 grid gap-4 md:grid-cols-2",
                  onSubmit: async (s) => {
                    if ((s.preventDefault(), !_ || !O)) return;
                    const a = {};
                    let n = !1;
                    if (
                      (T.plan !== O.plan && ((a.plan = T.plan), (n = !0)),
                      T.seatLimit !== O.seatLimit)
                    ) {
                      if ("" === T.seatLimit.trim())
                        return void i.error(
                          "Seat limit cannot be blank when updating",
                        );
                      const e = Number(T.seatLimit);
                      if (Number.isNaN(e))
                        return void i.error("Seat limit must be a number");
                      ((a.seatLimit = e), (n = !0));
                    }
                    if (
                      (T.billingCycleStart !== O.billingCycleStart &&
                        ((a.billingCycleStart = T.billingCycleStart
                          ? new Date(T.billingCycleStart).toISOString()
                          : null),
                        (n = !0)),
                      "lifetime" === T.plan
                        ? ("lifetime" === O.plan && "" === O.billingCycleEnd) ||
                          ((a.billingCycleEnd = null), (n = !0))
                        : T.billingCycleEnd !== O.billingCycleEnd &&
                          ((a.billingCycleEnd = T.billingCycleEnd
                            ? new Date(T.billingCycleEnd).toISOString()
                            : null),
                          (n = !0)),
                      !n)
                    )
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("select", {
                          ...
                          value: T.plan,
                          onChange: (e) => oe("plan", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                          children: x.map((e) =>
                            n.jsx(
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          min: 0,
                          value: T.seatLimit,
                          onChange: (e) => oe("seatLimit", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                        }),
                      ],
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          type: "date",
                          value: T.billingCycleStart,
                          onChange: (e) =>
                            oe("billingCycleStart", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                        }),
                      ],
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          type: "date",
                          value: T.billingCycleEnd,
                          onChange: (e) =>
                            oe("billingCycleEnd", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400 disabled:opacity-60",
                          disabled:
                            "lifetime" === T.plan || "annual" === T.plan,
                        }),
                        "annual" === T.plan &&
                          n.jsx("p", {
                            className: "theme-text-secondary text-[11px]",
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("button", {
                          ...
                          disabled: q,
                          children: q ? "Saving…" : "Save changes",
                        }),
                      ],
                    }),
                  ],
              ...
              children: [
                ...
                n.jsxs("form", {
                  onSubmit: async (s) => {
                    if (
                      (s.preventDefault(),
                      !G.newPassword || G.newPassword.length < 6)
                    )
                      return void i.error(
                        "New password must be at least 6 characters",
                      );
                    if (G.newPassword !== G.confirmPassword)
                      return void i.error("New passwords do not match");
                    const a = h?.email || "onyedika.akoma@gmail.com";
                    J(!0);
                    try {
                      (await (async function (s, a, n) {
                        ...
                        return l;
                      })(a, G.currentPassword, G.newPassword),
                    ...
                    n.jsxs("div", {
                      ...
                      children: [
                        ...
                        n.jsx("input", {
                          ...
                          value: G.newPassword,
                          onChange: (e) =>
                            Y((t) => ({ ...t, newPassword: e.target.value })),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                          required: !0,
                          minLength: 6,
                      ...
                      children: [
                        ...
                        n.jsx("button", {
                          ...
                          className:
                            "rounded-full bg-gradient-to-r from-sky-400 to-emerald-400 px-6 py-2.5 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-950 shadow-[0_15px_40px_-20px_rgba(56,189,248,0.7)] transition hover:shadow-[0_18px_46px_-18px_rgba(16,185,129,0.7)] disabled:cursor-not-allowed disabled:opacity-70",
                          disabled: H,
                          children: H ? "Changing..." : "Change Password",
                        }),
                      ],
                    }),
                  ],
