...
import { f as i } from "./format-CiGwivc0.js";
function c() {
  const { logout: c, accessToken: m, user: u } = e(),
    ...
    F = async () => {
      if (m) {
        v(!0);
        try {
          const e = await n.get(`${d}/api/v1/purchase-orders`, {
    ...
    O = async () => {
      if (m)
        try {
          const e = await n.get(`${d}/api/v1/suppliers`, {
            headers: { Authorization: `Bearer ${m}` },
          });
          b(e.data || []);
        } catch (e) {}
    ...
    _ = async () => {
      if (m)
        try {
          const e = await n.get(`${d}/api/v1/products`, {
            headers: { Authorization: `Bearer ${m}` },
          });
          f(e.data || []);
        } catch (e) {}
              ...
              s.jsxs("form", {
                onSubmit: async (e) => {
                  if ((e.preventDefault(), !m))
                    return void l.error("Not authenticated");
                  if (!k.supplierId)
                    return void l.error("Please select a supplier");
                  if (0 === k.items.length)
                    return void l.error("Please add at least one item");
                  const t = await (async () => {
                    if (!m || !u) return null;
                    ...
                    try {
                      const e =
                        (
                          await n.get(`${d}/api/v1/locations`, {
                            headers: { Authorization: `Bearer ${m}` },
                          })
                        ).data || [];
                  ...
                  const { subtotal: s, tax: r, total: a } = T(k.items);
                  try {
                    (w
                      ? (await n.put(
                          `${d}/api/v1/purchase-orders/${w}`,
                          {
                            locationId: t,
                        ...
                        l.success("Purchase order updated successfully"))
                      : (await n.post(
                          `${d}/api/v1/purchase-orders`,
                          {
                            locationId: t,
                            supplierId: k.supplierId,
                            items: k.items,
                        ...
                        l.success("Purchase order created successfully")),
                      j(!1),
                      C(null),
                      I({
                        supplierId: "",
                              ...
                              children: [
                                ...
                                s.jsx("button", {
                                  ...
                                  onClick: async () => {
                                    ...
                                    else l.error("Supplier name is required");
                                  },
                                  className:
                                ...
                                children: [
                                  s.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      s.jsx("span", {
                                        className: `rounded-full px-3 py-1 text-xs font-semibold ${M(e.status)}`,
                                        children: e.status
                                          .replace("_", " ")
                                          .toUpperCase(),
                                      }),
                                          ...
                                          onClick: () =>
                                            (async (e) => {
                                              if (
                                                ...
                                                try {
                                                  (await n.patch(
                                                    `${d}/api/v1/purchase-orders/${e}/approve`,
                                                    {},
                                                    {
                                                      headers: {
                                                        Authorization: `Bearer ${m}`,
                                      ...
                                      onClick: () =>
                                        (async (e) => {
                                          if (
                                            ...
                                            try {
                                              (await n.patch(
                                                `${d}/api/v1/purchase-orders/${e}/cancel`,
                                                {},
                                                {
                                                  headers: {
                                                    Authorization: `Bearer ${m}`,
