...
function v(n, r) {
  ...
  const h = o(d, r),
    l = e(n, 0);
  (l.setFullYear(u, 0, c), l.setHours(0, 0, 0, 0));
  const m = o(l, r);
    ...
    s =
      ...
      +(function (t, n) {
        const r = a(),
          ...
          u = v(t, n),
          s = e(t, 0);
        return (s.setFullYear(u, 0, i), s.setHours(0, 0, 0, 0), o(s, n));
      })(u, i);
...
function J(e, n, r) {
  const o = a(),
    i = o.locale ?? y,
    u =
      o.firstWeekContainsDate ?? o.locale?.options?.firstWeekContainsDate ?? 1,
    s = o.weekStartsOn ?? o.locale?.options?.weekStartsOn ?? 0,
    c = t(e);
  if (!d(c)) throw new RangeError("Invalid time value");
  let h = n
    .match(X)
    .map((t) => {
      const e = t[0];
      if ("p" === e || "P" === e) {
        return (0, j[e])(t, i.formatLong);
      }
      return t;
    })
    .join("")
  ...
  i.localize.preprocessor && (h = i.localize.preprocessor(c, h));
  const l = { firstWeekContainsDate: u, weekStartsOn: s, locale: i };
  return h
    .map((t) => {
      ...
      return (0, N[r[0]])(c, r, i.localize, l);
    })
    .join("");
}
function I(t) {
