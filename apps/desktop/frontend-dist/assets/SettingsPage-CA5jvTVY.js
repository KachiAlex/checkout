...
import { r as c } from "./receiptService-DrfQpUBz.js";
import { u as d, f as m } from "./scannerDeviceService-DY9l7AbX.js";
import {
...
} from "./printerDeviceService-iyrg-p41.js";
...
function B() {
  const {
    ...
    [E, z] = a.useState(!1),
    [M, _] = a.useState(!1),
    q = ["monnify", "opay", "palmpay", "firstbank"],
    [O, W] = a.useState("monnify"),
    [G, Q] = a.useState({
      monnify: {
        enabled: !1,
        apiKey: "",
    ...
    [V, Y] = a.useState(!1),
    [J, X] = a.useState(!1),
    [ee, te] = a.useState({ description: "", percentage: "", enabled: !1 }),
    [se, ae] = a.useState(!1),
    [re, ne] = a.useState(null),
    [ie, le] = a.useState(""),
    [oe, ce] = a.useState(""),
    [de, me] = a.useState(!1),
    [xe, he] = a.useState(
    ...
    [je, Ne] = a.useState(!1),
    [ve, we] = a.useState(null),
    [ke, Ce] = a.useState([]),
    [Se, Ie] = a.useState(!1),
    [Pe, Be] = a.useState(x?.locationId || ""),
    [Ae, Te] = a.useState(!1),
    [Ue, $e] = a.useState(!1),
    [Le, Ke] = a.useState(null),
    [Re, De] = a.useState({
      name: "",
      address: "",
      timezone: Intl.DateTimeFormat().resolvedOptions().timeZone || "UTC",
    }),
    { devices: Fe, removeDevice: Ee } = d(),
    [ze, Me] = a.useState(!1),
    [_e, qe] = a.useState([]),
    Oe = a.useMemo(
  ...
  (a.useEffect(() => {
          ...
          try {
            ...
            Q((t) => ({
              monnify: {
                ...
                contractCode:
                  s.monnify?.contractCode ?? e.monnifyContractCode ?? "",
    ...
    a.useEffect(() => {
      0 !== ke.length &&
        (K.locationId || R((e) => ({ ...e, locationId: ke[0].id })));
    }, [ke, K.locationId]),
    a.useEffect(() => {
      if (!Oe) return void qe([]);
      (async () => {
        if (p) {
          Me(!0);
          try {
  ...
  const We = async () => {
        ...
        if (!ie || ie.length < 4 || ie.length > 64)
          ...
          try {
            (await (async function (s, a) {
              ...
              r.success(`PIN reset successfully for ${re.name}`),
              ae(!1),
              ne(null),
              le(""),
              ce(""));
    ...
    [He, Ze] = a.useState("general"),
    Ve = [
      { id: "general", label: "General", icon: "⚙️" },
      { id: "receipts", label: "Receipts", icon: "🧾" },
      ...(Oe ? [{ id: "payments", label: "Payments", icon: "💳" }] : []),
      ...(Oe ? [{ id: "users", label: "Users & Locations", icon: "👥" }] : []),
                                      ...
                                      n.jsx("div", {
                                        ...
                                        children: n.jsx("button", {
                                          onClick: async () => {
                                            ...
                                            const s = parseFloat(ee.percentage);
                                          ...
                                          if (
                                            ...
                                            try {
                                              (await e.post(
                                                ...
                                                r.success(
                                                  `Location "${Re.name}" created successfully`,
                                                ),
                                                De({
                                                  name: "",
                                                  address: "",
                                      ...
                                      if (Oe) {
                                        ...
                                        try {
                                          ...
                                          (await c.registerPrinter(
                                            ...
                                            ? (r.success(
                                                `Printer "${fe.id}" registered successfully`,
                                              ),
                                              ge({
                                                id: "default-printer",
                                                type: "serial",
                                ...
                                children: [
                                  ...
                                  n.jsx("button", {
                                    onClick: async () => {
                                      ...
                                      try {
                                        const e = await m(x?.locationId);
                                        (qe(e), r.success("Devices refreshed"));
                                      } catch (e) {
          ...
          children: n.jsxs("div", {
            ...
            children: [
              n.jsxs("h3", {
                ...
                children: ["Reset PIN for ", re.name],
              }),
              n.jsx("p", {
              ...
              n.jsxs("div", {
                ...
                children: [
                  n.jsx("button", {
                    ...
                    children: de ? "Resetting..." : "Reset PIN",
                  }),
                  n.jsx("button", {
                    onClick: () => {
                      (ae(!1), ne(null), le(""), ce(""));
