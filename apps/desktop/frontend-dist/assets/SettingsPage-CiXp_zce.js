...
import { B as o } from "./BrandMark-HxNEMnER.js";
import { r as d } from "./receiptService-CYsJo9Ta.js";
import { u as c, f as m } from "./scannerDeviceService-CDWuW5Jf.js";
import {
  ...
  requestBluetoothPrinter as v,
  connectBluetoothPrinter as j,
  closeSerialPort as N,
} from "./printerDeviceService-C5B92oVi.js";
import { f as w } from "./format-BJFo2Mkz.js";
...
function S({ onClose: e }) {
  ...
  const B = async () => {
      if (l) {
        m(!0);
        try {
          const e = await x(null == t ? void 0 : t.locationId);
          o(e);
        } catch (e) {
                ...
                try {
                  ...
                  const a =
                    ...
                    n = await g({
                      ...
                      locationId: null == t ? void 0 : t.locationId,
                      config: {
                        baudRate: 9600,
                        dataBits: 8,
                        stopBits: 1,
                                      ...
                                      if (l) {
                                        ...
                                        try {
                                          ...
                                          if (
                                            ...
                                            await d.printReceiptToBluetooth(
                                              t,
                                              e.characteristic,
                                            );
                                          }
                                ...
                                n.jsx("button", {
                                  onClick: () =>
                                    (async (e) => {
                                      var t;
                                      try {
                                        (e.port && (await N(e.port)),
                                          (null == (t = e.bluetoothDevice)
                                            ? void 0
                                            : t.gatt) &&
                                            e.bluetoothDevice.gatt.disconnect(),
                                          o(i.filter((t) => t.id !== e.id)),
  ...
  const f = async () => {
    ...
    if (l) {
      ...
      try {
        ...
        (d(s.data), s.data.logoUrl && b(s.data.logoUrl));
      } catch (a) {
        404 !== (null == (s = a.response) ? void 0 : s.status) &&
        ...
        onSubmit: async (s) => {
          ...
          if ((s.preventDefault(), l)) {
            ...
            try {
              ...
              r.error(
                (null == (n = null == (a = i.response) ? void 0 : a.data)
                  ? void 0
                  : n.message) || "Failed to save customization settings",
              );
            } finally {
              h(!1);
            }
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("input", {
                    type: "text",
                    value: o.companyName,
                    onChange: (e) => d({ ...o, companyName: e.target.value }),
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("input", {
                    type: "text",
                    value: o.address || "",
                    onChange: (e) => d({ ...o, address: e.target.value }),
              ...
              n.jsxs("div", {
                children: [
                  ...
                  n.jsx("input", {
                    type: "text",
                    value: o.phone || "",
                    onChange: (e) => d({ ...o, phone: e.target.value }),
              ...
              n.jsxs("div", {
                children: [
                  ...
                  n.jsx("input", {
                    type: "email",
                    value: o.email || "",
                    onChange: (e) => d({ ...o, email: e.target.value }),
              ...
              n.jsxs("div", {
                children: [
                  ...
                  n.jsx("input", {
                    type: "url",
                    value: o.website || "",
                    onChange: (e) => d({ ...o, website: e.target.value }),
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("input", {
                    type: "text",
                    value: o.headerInfo || "",
                    onChange: (e) => d({ ...o, headerInfo: e.target.value }),
              ...
              n.jsxs("div", {
                ...
                children: [
                  ...
                  n.jsx("input", {
                    ...
                    onChange: (e) => d({ ...o, footerMessage: e.target.value }),
...
function B() {
  ...
  const {
    ...
    [z, M] = a.useState(!1),
    [_, q] = a.useState(!1),
    O = ["monnify", "opay", "palmpay", "firstbank"],
    [W, G] = a.useState("monnify"),
    [Q, H] = a.useState({
      monnify: {
        enabled: !1,
        apiKey: "",
    ...
    [Y, J] = a.useState(!1),
    [X, ee] = a.useState(!1),
    [te, se] = a.useState({ description: "", percentage: "", enabled: !1 }),
    [ae, re] = a.useState(!1),
    [ne, le] = a.useState(null),
    [ie, oe] = a.useState(""),
    [de, ce] = a.useState(""),
    [me, xe] = a.useState(!1),
    [he, pe] = a.useState(
    ...
    [je, Ne] = a.useState(!1),
    [we, ke] = a.useState(null),
    [Ce, Se] = a.useState([]),
    [Ie, Pe] = a.useState(!1),
    [Be, Ae] = a.useState((null == h ? void 0 : h.locationId) || ""),
    [Te, Ue] = a.useState(!1),
    [$e, Le] = a.useState(!1),
    [Ke, Re] = a.useState(null),
    [De, Fe] = a.useState({
      name: "",
      address: "",
      timezone: Intl.DateTimeFormat().resolvedOptions().timeZone || "UTC",
    }),
    { devices: Ee, removeDevice: ze } = c(),
    [Me, _e] = a.useState(!1),
    [qe, Oe] = a.useState([]),
    We = a.useMemo(
      () =>
        "admin" === (null == h ? void 0 : h.role) ||
        (null == h ? void 0 : h.isPlatformAdmin),
      [null == h ? void 0 : h.role, null == h ? void 0 : h.isPlatformAdmin],
    );
  (a.useEffect(() => {
    (async () => {
      var s, a;
      if (We) {
        ...
        try {
          ...
          r.error(
            (null ==
            (a =
              null == (s = null == n ? void 0 : n.response) ? void 0 : s.data)
              ? void 0
              : a.message) || "Unable to load users",
          );
        } finally {
          T(!1);
        }
          ...
          try {
            ...
            H((t) => {
              ...
              return {
                monnify: {
                  enabled:
                    (null == (a = s.monnify) ? void 0 : a.enabled) ??
                    e.monnifyEnabled ??
                    !1,
                  apiKey:
                    (null == (r = s.monnify) ? void 0 : r.apiKey) ??
                    e.monnifyApiKey ??
                    "",
                  secretKey:
                    (null == (n = s.monnify) ? void 0 : n.secretKey) ??
                    e.monnifySecretKey ??
                    "",
                  contractCode:
                    (null == (l = s.monnify) ? void 0 : l.contractCode) ??
                    e.monnifyContractCode ??
                    "",
                  merchantId:
                    (null == (i = s.monnify) ? void 0 : i.merchantId) ?? "",
                  terminalId:
                    (null == (o = s.monnify) ? void 0 : o.terminalId) ?? "",
                  webhookSecret:
                    (null == (d = s.monnify) ? void 0 : d.webhookSecret) ??
                    e.monnifyWebhookSecret ??
                    "",
                },
                opay: {
                  enabled: (null == (c = s.opay) ? void 0 : c.enabled) ?? !1,
                  apiKey: (null == (m = s.opay) ? void 0 : m.apiKey) ?? "",
                  secretKey:
                    (null == (x = s.opay) ? void 0 : x.secretKey) ?? "",
                  contractCode:
                    (null == (h = s.opay) ? void 0 : h.contractCode) ?? "",
                  merchantId:
                    (null == (p = s.opay) ? void 0 : p.merchantId) ?? "",
                  terminalId:
                    (null == (u = s.opay) ? void 0 : u.terminalId) ?? "",
                  webhookSecret:
                    (null == (y = s.opay) ? void 0 : y.webhookSecret) ?? "",
                },
                palmpay: {
                  enabled: (null == (b = s.palmpay) ? void 0 : b.enabled) ?? !1,
                  apiKey: (null == (f = s.palmpay) ? void 0 : f.apiKey) ?? "",
                  secretKey:
                    (null == (g = s.palmpay) ? void 0 : g.secretKey) ?? "",
                  contractCode:
                    (null == (v = s.palmpay) ? void 0 : v.contractCode) ?? "",
                  merchantId:
                    (null == (j = s.palmpay) ? void 0 : j.merchantId) ?? "",
                  terminalId:
                    (null == (N = s.palmpay) ? void 0 : N.terminalId) ?? "",
                  webhookSecret:
                    (null == (w = s.palmpay) ? void 0 : w.webhookSecret) ?? "",
                },
                firstbank: {
                  enabled:
                    (null == (k = s.firstbank) ? void 0 : k.enabled) ?? !1,
                  apiKey: (null == (C = s.firstbank) ? void 0 : C.apiKey) ?? "",
                  secretKey:
                    (null == (S = s.firstbank) ? void 0 : S.secretKey) ?? "",
                  contractCode:
                    (null == (I = s.firstbank) ? void 0 : I.contractCode) ?? "",
                  merchantId:
                    (null == (P = s.firstbank) ? void 0 : P.merchantId) ?? "",
                  terminalId:
                    (null == (B = s.firstbank) ? void 0 : B.terminalId) ?? "",
                  webhookSecret:
                    (null == (A = s.firstbank) ? void 0 : A.webhookSecret) ??
                    "",
                },
              };
            });
    ...
    a.useEffect(() => {
      (async () => {
        ...
        if (We) {
          ...
          try {
            const a = (
              await e.get(`${t}/api/v1/tax-settings`, {
            ...
            (V(a),
              se({
                ...
                percentage:
                  (null == (s = a.percentage) ? void 0 : s.toString()) || "",
                enabled: a.enabled || !1,
              }));
          } catch (a) {
            V({ enabled: !1 });
    ...
    a.useEffect(() => {
      Ae((null == h ? void 0 : h.locationId) || "");
    }, [null == h ? void 0 : h.locationId]),
    a.useEffect(() => {
      0 !== Ce.length &&
        (R.locationId || D((e) => ({ ...e, locationId: Ce[0].id })));
    }, [Ce, R.locationId]),
    a.useEffect(() => {
      if (!We) return void Oe([]);
      (async () => {
        if (u) {
          _e(!0);
          try {
            const e = await m(null == h ? void 0 : h.locationId);
            Oe(e);
          } catch (e) {
          } finally {
            _e(!1);
    ...
    }, [u, null == h ? void 0 : h.locationId, We]));
  a.useEffect(() => {
    if (!We) return void ke(null);
    (async () => {
      try {
        const e = new Promise((e) => {
            setTimeout(() => e(!1), 3e3);
          }),
          t = d.isAvailable().catch(() => !1),
  ...
  const Ge = async () => {
    ...
    Qe = async () => {
      var s, a;
      if (ne)
        if (!ie || ie.length < 4 || ie.length > 64)
          ...
          try {
            (await (async function (s, a) {
              ...
              r.success(`PIN reset successfully for ${ne.name}`),
              re(!1),
              le(null),
              oe(""),
              ce(""));
      ...
      if (window.confirm(`Delete user ${s.name}? This cannot be undone.`))
        try {
          (await (async function (s) {
            ...
            K((e) => e.filter((e) => e.id !== s.id)),
            r.success(`Deleted user ${s.name}`));
        } catch (l) {
          r.error(
            (null ==
            (n =
              null == (a = null == l ? void 0 : l.response) ? void 0 : a.data)
              ? void 0
              : n.message) || "Unable to delete user",
          );
        }
    },
    [Ze, Ve] = a.useState("general"),
    Ye = [
      { id: "general", label: "General", icon: "⚙️" },
      { id: "receipts", label: "Receipts", icon: "🧾" },
      ...(We ? [{ id: "payments", label: "Payments", icon: "💳" }] : []),
      ...(We ? [{ id: "users", label: "Users & Locations", icon: "👥" }] : []),
                  ...
                  children: [
                    ...
                    n.jsx(P, {
                      ...
                      children: n.jsxs("form", {
                        ...
                        onSubmit: async (s) => {
                          var a, n;
                          if ((s.preventDefault(), y && f && v))
                            if (f === v)
                              if (f.length < 4 || f.length > 64)
                                r.error(
                                  ...
                                  r.error(
                                    ...
                                    (n =
                                      ...
                                      (a = null == l ? void 0 : l.response)
                                        ...
                                        : a.data)
                                      ? void 0
                                      : n.message) || "Unable to update PIN",
                                  );
                                } finally {
                                  B(!1);
                                }
                                      ...
                                      n.jsx("div", {
                                        ...
                                        children: n.jsx("button", {
                                          onClick: async () => {
                                            ...
                                            const n = parseFloat(te.percentage);
                                          ...
                                          if (
                                            ...
                                            try {
                                              (await e.post(
                                                ...
                                                r.success(
                                                  `Location "${De.name}" created successfully`,
                                                ),
                                                Fe({
                                                  name: "",
                                                  address: "",
                          ...
                          n.jsxs("form", {
                              ...
                              if (
                                ...
                                try {
                                  const s = await (async function (s) {
                                    ...
                                    role: R.role,
                                    locationId: R.locationId || void 0,
                                    pin: R.pin || void 0,
                                  });
                                  (K((e) => [s.user, ...e]),
                                    r.success(
                                  ...
                                  r.error(
                                    ...
                                    (n =
                                      ...
                                      (a = null == l ? void 0 : l.response)
                                        ...
                                        : a.data)
                                      ? void 0
                                      : n.message) || "Unable to create user",
                                  );
                                } finally {
                                  $(!1);
                                }
                            ...
                            children: [
                              ...
                              n.jsx("button", {
                                ...
                                children: U ? "Adding user…" : "Add user",
                              }),
                            ],
                          }),
                          n.jsxs("div", {
                                      ...
                                      if (We) {
                                        ...
                                        try {
                                          ...
                                          if ("serial" === ge.type) {
                                            ...
                                            ((e.host = ge.host),
                                              (e.port = parseInt(ge.port, 10)));
                                          }
                                          (await d.registerPrinter(
                                            ge.id,
                                            ge.type,
                                            e,
                                          ))
                                            ? (r.success(
                                                `Printer "${ge.id}" registered successfully`,
                                              ),
                                              ve({
                                                id: "default-printer",
                                                type: "serial",
                                  ...
                                  n.jsx("button", {
                                    onClick: async () => {
                                      ...
                                      try {
                                        ...
                                        (Oe(e), r.success("Devices refreshed"));
                                      } catch (e) {
          ...
          n.jsxs("div", {
            ...
            children: [
              ...
              n.jsx("span", {
                ...
                children: (null == p ? void 0 : p.slug) ?? "unknown",
              }),
              ". Role:",
              " ",
              n.jsx("span", {
                className: "theme-text-primary font-medium capitalize",
                children: (null == h ? void 0 : h.role) ?? "unknown",
              }),
            ],
          }),
        ],
          ...
          children: n.jsxs("div", {
            ...
            children: [
              n.jsxs("h3", {
                ...
                children: ["Reset PIN for ", ne.name],
              }),
              n.jsx("p", {
              ...
              n.jsxs("div", {
                ...
                children: [
                  n.jsx("button", {
                    ...
                    children: me ? "Resetting..." : "Reset PIN",
                  }),
                  n.jsx("button", {
                    onClick: () => {
                      (re(!1), le(null), oe(""), ce(""));
