...
import { B as l } from "./BrandMark-HxNEMnER.js";
import { T as o } from "./ThemeToggle-TO1YIz9m.js";
import { f as c } from "./format-BJFo2Mkz.js";
function m() {
    ...
    I = async () => {
      ...
      if (x) {
        ...
        try {
          const e = (
            (
              await d.get(`${n}/api/v1/purchase-orders`, {
          ...
          401 !== (null == (e = t.response) ? void 0 : e.status) &&
            i.error("Failed to load purchase orders");
        } finally {
          N(!1);
        }
      }
      ...
      if (p && x && h.length > 0) {
        ...
        e
          ...
          : (async (e) => {
              if (x)
                try {
                  const t = await d.get(`${n}/api/v1/purchase-orders/${e}`, {
                    headers: { Authorization: `Bearer ${x}` },
                  });
                  (f(t.data), P(t.data));
                } catch (t) {
                  i.error("Failed to load purchase order");
                }
            })(p);
      }
    }, [p, x, h]));
        ...
        const e = parseFloat(s) || 0,
          t =
            ...
            (r =
              null == y
                ? void 0
                : y.items.find((e) => e.productId === d.productId))
              ? void 0
              : r.receivedQuantity) || 0);
        ((d.receivedQuantity = Math.min(Math.max(0, e), t)),
          (d.totalCostCents = d.receivedQuantity * d.unitCostCents));
      } else ("batchNumber" !== t && "expiryDate" !== t) || (d[t] = s);
      ((a[e] = d), C(a));
    },
    D = () => {
              ...
              r.jsxs("form", {
                onSubmit: async (e) => {
                  ...
                  if ((e.preventDefault(), !x || !y))
                    return void i.error("Not authenticated or no PO selected");
                  if (w.some((e) => e.receivedQuantity > 0)) {
                    for (const e of w)
                      if (e.receivedQuantity > 0) {
                        const t = y.items.find(
                          ...
                          s = (null == t ? void 0 : t.receivedQuantity) || 0,
                          r = ((null == t ? void 0 : t.quantity) || 0) - s;
                    ...
                    g(!0);
                    try {
                      const { subtotal: e, tax: s, total: r } = D(),
                        a =
                          null ==
                          (t = (
                            await d.post(
                      ...
                      i.error(
                        (null ==
                        (r = null == (s = a.response) ? void 0 : s.data)
                          ? void 0
                          : r.message) || "Failed to create GRN",
                      );
                    } finally {
                      g(!1);
                    }
                        ...
                        : r.jsx("div", {
                            ...
                            children: w.map((e, t) => {
                              const s = y.items.find(
                                ...
                                a =
                                  (null == s ? void 0 : s.receivedQuantity) ||
                                  0,
                                d =
                                  ((null == s ? void 0 : s.quantity) || 0) - a;
                              return r.jsxs(
                                "div",
                                {
                                  className:
