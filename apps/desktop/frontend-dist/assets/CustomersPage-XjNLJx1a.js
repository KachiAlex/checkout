      ...
      if (n) {
        ...
        try {
          ...
          401 !== (null == (e = t.response) ? void 0 : e.status) &&
            o.error("Failed to load customers");
        } finally {
          c(!1);
        }
      }
                              ...
                              children: [
                                ...
                                s.jsx("button", {
                                  onClick: () =>
                                    (async (e) => {
                                      var t, s;
                                      const d = prompt("Enter points to add:");
                                      if (d && !isNaN(Number(d)))
                                        try {
                                          (await a.post(
                                ...
                                s.jsx("button", {
                                  onClick: () =>
                                    (async (e) => {
                                      var t, s;
                                      const d = prompt("Enter amount in NGN:");
                                      if (d && !isNaN(Number(d)))
                                        try {
                                          (await a.post(
                  ...
                  onSubmit: async (e) => {
                    ...
                    if ((e.preventDefault(), n))
                      try {
                        ...
                        o.error(
                          (null ==
                          (s = null == (t = d.response) ? void 0 : t.data)
                            ? void 0
                            : s.message) || "Failed to save customer",
                        );
                      }
                  ...
                  children: [
                    ...
                    s.jsxs("div", {
                      children: [
                        ...
                        s.jsx("input", {
                          type: "email",
                          value: y.email,
                          onChange: (e) => v({ ...y, email: e.target.value }),
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                        }),
                      ],
                        ...
                        s.jsxs("div", {
                          children: [
                            ...
                            s.jsx("input", {
                              ...
                              value: y.dateOfBirth,
                              onChange: (e) =>
                                v({ ...y, dateOfBirth: e.target.value }),
                              className:
                                "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                            }),
                          ],
                    ...
                    s.jsxs("div", {
                      children: [
                        ...
                        s.jsx("textarea", {
                          value: y.address,
                          onChange: (e) => v({ ...y, address: e.target.value }),
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                          rows: 2,
                        }),
                    ...
                    s.jsxs("div", {
                      children: [
                        ...
                        s.jsx("textarea", {
                          value: y.notes,
                          onChange: (e) => v({ ...y, notes: e.target.value }),
                          className:
                            "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                          rows: 3,
                        }),
