...
import { T as r } from "./ThemeToggle-TO1YIz9m.js";
import { B as d } from "./BrandMark-HxNEMnER.js";
import { g as o, u as c } from "./subscriptionPricingService-CEuaZt0p.js";
async function m(s) {
...
function p({ status: e }) {
  ...
  return l.jsxs("span", {
    ...
    children: [
      l.jsx("span", { className: "h-1.5 w-1.5 rounded-full bg-current" }),
      e,
    ],
  });
}
function h() {
  var h, b, g, y, f;
  const { user: v, logout: j } = s((e) => ({ user: e.user, logout: e.logout })),
  ...
  if (
    (a.useEffect(() => {
      if (!(null == v ? void 0 : v.isPlatformAdmin)) return;
      ((async () => {
        var s, a;
        k(!0);
        try {
          ...
          i.error(
            (null ==
            (a =
              null == (s = null == l ? void 0 : l.response) ? void 0 : s.data)
              ? void 0
              : a.message) || "Unable to load tenants",
          );
        } finally {
          k(!1);
        }
        ...
        (async () => {
          ...
          try {
            ...
            (ee(a),
              ...
              de({
                starter:
                  ((null == (e = a.starter) ? void 0 : e.priceCents) ?? 0) /
                  100,
                professional:
                  ((null == (t = a.professional) ? void 0 : t.priceCents) ??
                    0) / 100,
                enterprise:
                  ((null == (s = a.enterprise) ? void 0 : s.priceCents) ?? 0) /
                  100,
              }));
          } catch (n) {
            i.error(
              (null ==
              (l =
                null == (a = null == n ? void 0 : n.response) ? void 0 : a.data)
                ? void 0
                : l.message) || "Unable to load pricing",
            );
          } finally {
            se(!1);
          }
        })());
    }, [null == v ? void 0 : v.isPlatformAdmin]),
    !(null == v ? void 0 : v.isPlatformAdmin))
  )
    return l.jsx(n, { to: "/login", replace: !0 });
  const oe = a.useMemo(() => {
      if (!$.trim()) return w;
    ...
    ce = a.useMemo(
      () => ({
        total: w.length,
        active: w.filter((e) => "active" === e.status).length,
        pending: w.filter((e) => "pending" === e.status).length,
        suspended: w.filter((e) => "suspended" === e.status).length,
      }),
      [w],
    ),
    me = (e) => {
          ...
          if ("lifetime" === t) a.billingCycleEnd = "";
            ...
            const e =
              a.billingCycleStart && "" !== a.billingCycleStart.trim()
                ...
                : (null == R ? void 0 : R.billingCycleStart)
                  ? new Date(R.billingCycleStart)
                  : new Date();
            ((a.billingCycleStart && "" !== a.billingCycleStart.trim()) ||
              (a.billingCycleStart = e.toISOString().slice(0, 10)),
              (a.billingCycleEnd = ue(e).toISOString().slice(0, 10)));
          } else
            (null == R ? void 0 : R.billingCycleEnd)
              ? (a.billingCycleEnd = R.billingCycleEnd)
              : (a.billingCycleEnd = "");
        return (
          "billingCycleStart" === e &&
            "annual" === s.plan &&
            (a.billingCycleEnd = t
              ? ue(new Date(t)).toISOString().slice(0, 10)
              : ""),
          a
        );
      });
    ...
    ge = async (s) => {
      ...
      try {
        ...
        i.error(
          (null ==
          (l = null == (a = null == n ? void 0 : n.response) ? void 0 : a.data)
            ? void 0
            : l.message) || "Unable to reset admin PIN",
        );
      } finally {
        T(null);
      }
    ...
    ye = async (s) => {
      ...
      try {
        const a = await (async function (s, a) {
          ...
          return l;
        })(s.id, { reason: n.trim() || void 0 });
        (C((e) => e.map((e) => (e.id === a.id ? a : e))),
          i.success(`${s.name} suspended`));
      } catch (r) {
        i.error(
          (null ==
          (l = null == (a = null == r ? void 0 : r.response) ? void 0 : a.data)
            ? void 0
            : l.message) || "Unable to suspend tenant",
        );
      } finally {
        T(null);
      }
    ...
    fe = async (e) => {
      ...
      T(`${e.id}:activate`);
      try {
        const t = await m(e.id);
        (C((e) => e.map((e) => (e.id === t.id ? t : e))),
          i.success(
            "suspended" === e.status
              ? `${e.name} reactivated`
              : `${e.name} activated`,
        ...
        i.error(
          (null ==
          (s = null == (t = null == a ? void 0 : a.response) ? void 0 : t.data)
            ? void 0
            : s.message) || "Unable to activate tenant",
        );
      } finally {
        T(null);
      }
      ...
      if (
        ...
        try {
          (await (async function (s) {
            ...
            C((e) => e.filter((e) => e.id !== s.id)),
            I((e) => ((null == e ? void 0 : e.tenant.id) === s.id ? null : e)),
            i.success(`${s.name} deleted`));
        } catch (n) {
          i.error(
            (null ==
            (l =
              null == (a = null == n ? void 0 : n.response) ? void 0 : a.data)
              ? void 0
              : l.message) || "Unable to delete tenant",
          );
        } finally {
          T(null);
        }
                ...
                l.jsxs("div", {
                  ...
                  children: [
                    ...
                    l.jsx("button", {
                      onClick: async () => {
                        var e, t, a, l, n;
                        const { accessToken: r } = s.getState();
                        if (r)
                          if (Z) {
                            le(!0);
                            try {
                              ...
                              (ee(l),
                                ...
                                i.success("Pricing updated successfully"));
                            } catch (d) {
                              i.error(
                                (null ==
                                (n =
                                  null == (l = null == d ? void 0 : d.response)
                                    ? void 0
                                    : l.data)
                                  ? void 0
                                  : n.message) || "Unable to update pricing",
                              );
                            } finally {
                              le(!1);
                            }
                          } else i.error("Pricing config not loaded");
                        else i.error("Not authenticated");
                      },
                      disabled: ae || te,
                      className:
                      ...
                      children: ae ? "Saving..." : "Save Pricing",
                    }),
                  ],
                }),
              ],
        ...
        l.jsxs("section", {
          ...
          children: [
            ...
            l.jsxs("form", {
              ...
              onSubmit: async (s) => {
                var a, l, n, r;
                if ((s.preventDefault(), F.name.trim() && F.slug.trim()))
                  if (F.adminEmail.trim())
                    if (
                      "scheduled" !== F.billingStartMode ||
                      F.billingCycleStart
                    ) {
                      E(!0);
                      try {
                        const s = "immediate" === F.billingStartMode,
                          n =
                            s || F.billingCycleStart
                              ? s
                                ? new Date()
                                : new Date(F.billingCycleStart)
                              : void 0,
                          r = {
                            name: F.name.trim(),
                            ...
                            adminName: F.adminName.trim() || void 0,
                            ...
                            billingCycleEnd:
                              "lifetime" === F.plan
                                ...
                                : "annual" === F.plan && n
                                  ? ue(n).toISOString()
                                  : F.billingCycleEnd
                                    ? new Date(F.billingCycleEnd).toISOString()
                                    : void 0,
                          },
                          o = await (async function (s) {
                            const { data: a } = await e.post(
                        ...
                        if (s)
                          try {
                            ((c = await m(o.tenant.id)),
                              i.success(`${c.name} activated immediately`, {
                                duration: 6e3,
                              }));
                          } catch (d) {
                            i.error(
                              ...
                              (l =
                                ...
                                ? void 0
                                : l.message) ||
                                `${o.tenant.name} created, but activation failed`,
                            );
                          }
                        (C((e) => [c, ...e]),
                          I({ tenant: c, admin: o.admin }),
                          i.success(
                            `Tenant ${c.name} created. Admin account: ${o.admin.email} | Temporary PIN: ${o.admin.temporaryPin}`,
                            { duration: 1e4 },
                          ),
                          M({
                            name: "",
                        ...
                        i.error(
                          (null ==
                          (r =
                            null == (n = null == o ? void 0 : o.response)
                              ? void 0
                              : n.data)
                            ? void 0
                            : r.message) || "Unable to create tenant",
                        );
                      } finally {
                        E(!1);
                      }
                  ...
                  else i.error("Tenant admin email is required");
                else i.error("Name and slug are required");
              },
              children: [
                l.jsxs("div", {
                ...
                l.jsxs("div", {
                  ...
                  children: [
                    ...
                    l.jsx("input", {
                      ...
                      value: F.seatLimit,
                      onChange: (e) =>
                        M((t) => ({ ...t, seatLimit: e.target.value })),
                      className:
                        "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                    }),
                  ],
                ...
                l.jsxs("div", {
                  ...
                  children: [
                    ...
                    l.jsx("input", {
                      ...
                      value: F.adminName,
                      onChange: (e) =>
                        M((t) => ({ ...t, adminName: e.target.value })),
                      className:
                        "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                    }),
                  ],
                ...
                l.jsxs("div", {
                  ...
                  children: [
                    ...
                    l.jsx("input", {
                      ...
                      value: F.adminEmail,
                      onChange: (e) =>
                        M((t) => ({ ...t, adminEmail: e.target.value })),
                      className:
                        "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                      required: !0,
                    }),
                ...
                l.jsx("div", {
                  ...
                  children: l.jsx("div", {
                    ...
                    children: l.jsxs("p", {
                      ...
                      children: [
                        l.jsx("strong", { children: "Auto-generated PIN:" }),
                        ...
                        onChange: (e) =>
                          M((t) => {
                            ...
                            return {
                              ...
                              billingCycleEnd:
                                "annual" === t.plan && s
                                  ? ue(new Date(s)).toISOString().slice(0, 10)
                                  : "annual" === t.plan
                                    ? ""
                                    : t.billingCycleEnd,
                            };
                ...
                l.jsx("div", {
                  ...
                  children: l.jsx("button", {
                    ...
                    children: P ? "Provisioning…" : "Provision tenant",
                  }),
                }),
              ],
            }),
                                    ...
                                    children: l.jsxs("div", {
                                      ...
                                      children: [
                                        l.jsx("button", {
                                          ...
                                          onClick: () =>
                                            ((e) => {
                                              const t = me(e.billingCycleStart),
                                                s = {
                                                  plan: e.plan,
                                                  seatLimit:
                                                    void 0 !== e.seatLimit
                                        ...
                                        "active" !== e.status &&
                                          ...
                                          l.jsx("button", {
                                            ...
                                            className: be,
                                            onClick: () => fe(e),
                                            disabled: he(`${e.id}:activate`),
                                            children: he(`${e.id}:activate`)
                                              ? "Activating…"
                                              : "Activate now",
                                          }),
                                        l.jsx("button", {
                                          ...
                                          className: be,
                                          onClick: () => ge(e),
                                          disabled: he(`${e.id}:reset`),
                                          children: he(`${e.id}:reset`)
                                            ? "Resetting…"
                                            : "Reset PIN",
                                        }),
                                        "suspended" === e.status
                                          ...
                                          : l.jsx("button", {
                                              ...
                                              className: be,
                                              onClick: () => ye(e),
                                              disabled: he(`${e.id}:suspend`),
                                              children: he(`${e.id}:suspend`)
                                                ? "Suspending…"
                                                : "Suspend",
                                            }),
                                        l.jsx("button", {
                                          ...
                                          onClick: () => ve(e),
                                          disabled: he(`${e.id}:delete`),
                                          children: he(`${e.id}:delete`)
                                            ? "Deleting…"
                                            : "Delete",
                                        }),
                                      ],
            ...
            children: l.jsxs("div", {
              ...
              children: [
                ...
                l.jsxs("form", {
                  ...
                  onSubmit: async (s) => {
                    var a, l;
                    if ((s.preventDefault(), !U || !R)) return;
                    const n = {};
                    let r = !1;
                    if (
                      (B.plan !== R.plan && ((n.plan = B.plan), (r = !0)),
                      B.seatLimit !== R.seatLimit)
                    ) {
                      if ("" === B.seatLimit.trim())
                        return void i.error(
                          "Seat limit cannot be blank when updating",
                        );
                      const e = Number(B.seatLimit);
                      if (Number.isNaN(e))
                        return void i.error("Seat limit must be a number");
                      ((n.seatLimit = e), (r = !0));
                    }
                    if (
                      (B.billingCycleStart !== R.billingCycleStart &&
                        ((n.billingCycleStart = B.billingCycleStart
                          ? new Date(B.billingCycleStart).toISOString()
                          : null),
                        (r = !0)),
                      "lifetime" === B.plan
                        ? ("lifetime" === R.plan && "" === R.billingCycleEnd) ||
                          ((n.billingCycleEnd = null), (r = !0))
                        : B.billingCycleEnd !== R.billingCycleEnd &&
                          ((n.billingCycleEnd = B.billingCycleEnd
                            ? new Date(B.billingCycleEnd).toISOString()
                            : null),
                          (r = !0)),
                      !r)
                    )
                      return (
                        i.success("No subscription changes detected"),
                        void xe()
                      );
                    H(!0);
                    try {
                      ...
                      (C((e) => e.map((e) => (e.id === s.id ? s : e))),
                        i.success("Subscription updated"),
                        xe());
                    } catch (d) {
                      i.error(
                        (null ==
                        (l =
                          null == (a = null == d ? void 0 : d.response)
                            ...
                            : a.data)
                          ? void 0
                          : l.message) || "Unable to update subscription",
                      );
                    } finally {
                      H(!1);
                    }
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        ...
                        l.jsx("select", {
                          ...
                          value: B.plan,
                          onChange: (e) => pe("plan", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                          children: u.map((e) =>
                            l.jsx(
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        ...
                        l.jsx("input", {
                          ...
                          min: 0,
                          value: B.seatLimit,
                          onChange: (e) => pe("seatLimit", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                        }),
                      ],
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        ...
                        l.jsx("input", {
                          ...
                          type: "date",
                          value: B.billingCycleStart,
                          onChange: (e) =>
                            pe("billingCycleStart", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                        }),
                      ],
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        ...
                        l.jsx("input", {
                          ...
                          type: "date",
                          value: B.billingCycleEnd,
                          onChange: (e) =>
                            pe("billingCycleEnd", e.target.value),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400 disabled:opacity-60",
                          disabled:
                            "lifetime" === B.plan || "annual" === B.plan,
                        }),
                        "annual" === B.plan &&
                          l.jsx("p", {
                            className: "theme-text-secondary text-[11px]",
              ...
              children: [
                ...
                l.jsxs("form", {
                  onSubmit: async (s) => {
                    ...
                    if (
                      (s.preventDefault(),
                      !Q.newPassword || Q.newPassword.length < 6)
                    )
                      return void i.error(
                        "New password must be at least 6 characters",
                      );
                    if (Q.newPassword !== Q.confirmPassword)
                      return void i.error("New passwords do not match");
                    const n =
                      (null == v ? void 0 : v.email) ||
                      "onyedika.akoma@gmail.com";
                    X(!0);
                    try {
                      (await (async function (s, a, l) {
                        const { data: n } = await e.post(
                          `${t}/api/v1/auth/change-password`,
                          { email: s, currentPassword: a, newPassword: l },
                        );
                        return n;
                      })(n, Q.currentPassword, Q.newPassword),
                        i.success("Password changed successfully"),
                        K(!1),
                        V({
                          currentPassword: "",
                          newPassword: "",
                      ...
                      i.error(
                        (null ==
                        (l =
                          null == (a = null == r ? void 0 : r.response)
                            ? void 0
                            : a.data)
                          ? void 0
                          : l.message) || "Unable to change password",
                      );
                    } finally {
                      X(!1);
                    }
                    ...
                    l.jsxs("div", {
                      ...
                      children: [
                        ...
                        l.jsx("input", {
                          ...
                          value: Q.newPassword,
                          onChange: (e) =>
                            V((t) => ({ ...t, newPassword: e.target.value })),
                          className:
                            "theme-surface rounded-2xl border px-4 py-3 outline-none focus:ring-2 focus:ring-sky-400",
                          required: !0,
                          minLength: 6,
                      ...
                      children: [
                        ...
                        l.jsx("button", {
                          ...
                          className:
                            "rounded-full bg-gradient-to-r from-sky-400 to-emerald-400 px-6 py-2.5 text-xs font-semibold uppercase tracking-[0.25em] text-emerald-950 shadow-[0_15px_40px_-20px_rgba(56,189,248,0.7)] transition hover:shadow-[0_18px_46px_-18px_rgba(16,185,129,0.7)] disabled:cursor-not-allowed disabled:opacity-70",
                          disabled: W,
                          children: W ? "Changing..." : "Change Password",
                        }),
                      ],
                    }),
                  ],
