...
import { T as n } from "./ThemeToggle-in661Exp.js";
import { r as m } from "./receiptService-DrfQpUBz.js";
import { R as c } from "./ReceiptOptionsModal-Nm_7pA2y.js";
...
function p() {
  const { accessToken: o, user: p } = e(),
    ...
    he = 10,
    [pe, ue] = s.useState(!1),
    [je, be] = s.useState(null),
    [ye, Ne] = s.useState(!1),
    [fe, ge] = s.useState(null),
    ve = s.useMemo(() => `${w.from}-${w.to}`, [w.from, w.to]),
    we = s.useCallback(async () => {
      if (o)
        try {
      ...
      if (o) {
        ...
        try {
          ...
          switch (
            ...
            case "sales":
              (e.append("limit", he.toString()),
                e.append("offset", ((_ - 1) * he).toString()));
    ...
    }, [o, u, N, w.from, w.to, _, he, X]),
    Ce = s.useCallback((e) => `₦${e.toFixed(2)}`, []),
    Se = s.useCallback((e) => `₦${(e / 100).toFixed(2)}`, []),
    Me = s.useCallback((e) => {
      (be(e), ue(!0));
    }, []),
    Pe = s.useCallback(async (e) => {
      try {
    ...
    ze = s.useMemo(() => Te.find((e) => e.id === u) ?? Te[0], [u, Te]),
    Ae = s.useMemo(() => {
      if (!C?.orders) return [];
      const e = [];
      return (
  ...
  return (
    ...
    s.useEffect(() => {
      (K(1), G(1), Y(1), ee(1), te(1), ae(1), ie(1), ne(1), ce(1), xe(1));
    }, [u, ve, N]),
    s.useEffect(() => {
      o && ke();
    }, [o, u, N, ve, ke]),
                ...
                : l.jsxs(l.Fragment, {
                    children: [
                      ...
                      "sales" === u &&
                        C &&
                        (() => {
                          const e = C.pagination || {
                              limit: he,
                              offset: 0,
                              total: C.totalOrders || 0,
                              hasMore: !1,
                            },
                                  ...
                                  l.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      l.jsx("p", {
                                        className:
                                          "text-xl sm:text-2xl lg:text-3xl font-bold theme-text-primary",
                                        children: Ce(C.averageOrderValue),
                                      }),
                                    ],
                                  }),
                                ],
                        ...
                        l.jsxs("div", {
                          ...
                          children: [
                            ...
                            "product" === I
                              ...
                              : E &&
                                  E.staffPerformance &&
                                  E.staffPerformance.length > 0
                                ? (() => {
                                    const e = E.staffPerformance
                                        .map((e) => ({
                                          userId: e.userId,
                                          userName: e.userName,
                                  ...
                                  l.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      l.jsx("p", {
                                        className:
                                          "text-2xl font-bold theme-text-primary",
                                        children: Ce(O.averageOrderValue),
                                      }),
                                    ],
                                  }),
                                ],
                                      ...
                                      l.jsx("div", {
                                        ...
                                        children: e.items.map((e, s) => {
                                          ...
                                          return l.jsxs(
                                            "div",
                                            {
                                              className: `flex items-center justify-between p-5 rounded-xl border-2 ${$e(e.severity, e.type)} hover:scale-[1.02] transition-all ${r && t ? "ring-2 ring-red-500/50" : ""}`,
                                              children: [
                                                l.jsxs("div", {
                                                  className:
                                                    "flex items-center gap-4 flex-1 min-w-0",
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold text-yellow-400",
                                      children: A.warningCount || 0,
                                    }),
                                  ],
                                }),
                              ],
                            }),
                            A.fraudAlerts && A.fraudAlerts.length > 0
                              ? (() => {
                                  const e = Oe(A.fraudAlerts, le, he);
                                  return l.jsxs(l.Fragment, {
                                    children: [
                                      l.jsx("div", {
                                        className: "space-y-2",
                                        children: e.items.map((e, s) =>
                                          l.jsxs(
                                            "div",
                                            {
                                              className: `flex items-center justify-between p-4 rounded-lg border ${$e(e.severity)} hover:opacity-80 transition`,
                                              children: [
                                                l.jsxs("div", {
                                                  className:
                                                    "flex items-center gap-4 flex-1 min-w-0",
                      ...
                      "expiry" === u &&
                        ...
                        l.jsxs("div", {
                          ...
                          children: [
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold theme-text-primary",
                                      children: V.totalExpiringSoon || 0,
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
                            ...
                            (() => {
                              const e = [
                                  ...(V.expiringSoon || []).map((e) => ({
                                    ...e,
                                    status: "expiring",
                                  })),
                                  ...(V.expiredItems || []).map((e) => ({
                                    ...e,
                                    status: "expired",
                                  })),
                                ],
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold theme-text-primary",
                                      children: W.totalDiscrepancies || 0,
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
                                ...
                                l.jsxs("div", {
                                  ...
                                  children: [
                                    ...
                                    l.jsx("p", {
                                      className:
                                        "text-2xl font-bold text-yellow-400",
                                      children: W.warningCount || 0,
                                    }),
                                  ],
                                }),
                              ],
                            }),
                            W.shrinkageAlerts && W.shrinkageAlerts.length > 0
                              ? (() => {
                                  const e = Oe(W.shrinkageAlerts, me, he);
                                  return l.jsxs(l.Fragment, {
                                    children: [
                                      l.jsx("div", {
                                        className: "space-y-2",
                              ...
                              : l.jsx("p", {
                                  className:
                                    "theme-text-secondary text-center py-8",
                                  children:
                                    W.message || "No discrepancies detected",
                                }),
                          ],
                        }),
                      "staff" === u &&
                            ...
                            U.inventorizedProducts &&
                              l.jsxs("div", {
                                children: [
                                  ...
                                  U.inventorizedProducts.products &&
                                    U.inventorizedProducts.products.length >
                                      0 &&
                                    (() => {
                                      const e = Oe(
                                        U.inventorizedProducts.products,
                          ...
                          children: [
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("span", {
                                  className: `px-3 py-1 rounded-full text-xs font-medium ${$e(fe.severity)}`,
                                  children: fe.severity.toUpperCase(),
                                }),
                              ],
                            }),
                          ],
                              ...
                              ? l.jsxs("div", {
                                  children: [
                                    ...
                                    l.jsxs("p", {
                                      className:
                                        "font-medium theme-text-primary",
                                      children: [fe.daysExpired, " days ago"],
                                    }),
                                  ],
                                })
                              : l.jsxs("div", {
                                  children: [
                                    ...
                                    l.jsxs("p", {
                                      className:
                                        "font-medium theme-text-primary",
                                      children: [fe.daysUntilExpiry, " days"],
                                    }),
                                  ],
                                }),
                            l.jsxs("div", {
                          ...
                          children: [
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("p", {
                                  className: "font-medium theme-text-primary",
                                  children: Ce(fe.sales?.totalSales || 0),
                                }),
                              ],
                            }),
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("p", {
                                  className: "font-medium theme-text-primary",
                                  children: fe.sales?.orderCount || 0,
                                }),
                              ],
                            }),
                            l.jsxs("div", {
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("p", {
                                  className: "font-medium theme-text-primary",
                                  children:
                                    fe.sales?.orderCount > 0
                                      ? (
                                          (fe.sales?.itemCount || 0) /
                                          fe.sales.orderCount
                                        ).toFixed(1)
                                      : "0.0",
                                }),
                          ...
                          children: [
                            ...
                            l.jsxs("div", {
                              children: [
                                ...
                                l.jsx("p", {
                                  className: "font-medium theme-text-primary",
                                  children: Ce(fe.averageOrderValue),
                                }),
                              ],
                            }),
                          ],
                                      ...
                                      className:
                                        ...
                                        ("received" === fe.status
                                          ...
                                          : "approved" === fe.status
                                            ? "bg-blue-500/20 text-blue-400 border border-blue-500/50"
                                            : "bg-yellow-500/20 text-yellow-400 border border-yellow-500/50"),
                                      children: fe.status.toUpperCase(),
                                    }),
                                  ],
                                }),
                                l.jsxs("div", {
