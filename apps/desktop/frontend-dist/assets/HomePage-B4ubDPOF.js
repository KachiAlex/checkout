...
import { T as m } from "./ThemeToggle-DfPDAVEh.js";
import { g as c } from "./subscriptionPricingService-DmEGSGlJ.js";
const x = [
  {
    value: "retail",
    label: "Retail Store",
...
function h({ onSuccess: i, onCancel: n }) {
  const o = e(),
    [d, m] = t.useState(!1),
    [c, h] = t.useState("free"),
            ...
            children: [
              ...
              s.jsx("input", {
                ...
                onChange: (e) => {
                  ...
                  g((e) => ({ ...e, companyName: t, companySlug: v(t) }));
                },
              ...
              s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx("input", {
                    ...
                    value: b.companySlug,
                    onChange: (e) =>
                      g((t) => ({ ...t, companySlug: v(e.target.value) })),
                    placeholder: "acme-retail",
...
function p({ onSuccess: e, onCancel: i }) {
...
const u = "https://checkout-77d99.web.app",
  b = `${u}/checkout-icon-512.png`;
function g({
  title: e = "Checkout POS | Fast POS & Retail Management Software",
  description:
    t = "Checkout POS is the modern point-of-sale platform for pharmacies, supermarkets, restaurants, and retailers that need lightning-fast checkout, real-time inventory, and actionable analytics.",
  canonical: a,
  image: r,
  pathname: l,
  jsonLd: n,
  ...
  return s.jsxs(i, {
    children: [
      s.jsx("title", { children: e }),
      s.jsx("meta", { name: "description", content: t }),
      s.jsx("link", { rel: "canonical", href: o }),
      s.jsx("meta", { property: "og:title", content: e }),
      s.jsx("meta", { property: "og:description", content: t }),
      s.jsx("meta", { property: "og:type", content: "website" }),
      s.jsx("meta", { property: "og:url", content: o }),
      s.jsx("meta", { property: "og:image", content: d }),
      s.jsx("meta", { property: "og:site_name", content: "Checkout POS" }),
      s.jsx("meta", { name: "twitter:card", content: "summary_large_image" }),
      s.jsx("meta", { name: "twitter:title", content: e }),
      s.jsx("meta", { name: "twitter:description", content: t }),
      s.jsx("meta", { name: "twitter:image", content: d }),
      m.map((e, t) =>
        s.jsx(
          "script",
...
function w() {
    ...
    k = [
      {
        ...
        brand: { "@type": "Brand", name: "Checkout POS" },
        offers: {
          "@type": "Offer",
          priceCurrency: "USD",
  ...
  const S = (e) => (e && 0 !== e ? `$${(e / 100).toFixed(2)}` : "$0.00"),
    C = (e) => (e && 0 !== e ? e.toString() : "Unlimited");
  return s.jsxs(s.Fragment, {
    children: [
      s.jsx(g, {
        title:
          "Checkout POS | Lightning-Fast POS Software for Retail, Pharmacy & Restaurants",
        description:
          "Checkout POS helps pharmacies, supermarkets, restaurants, and retailers run faster transactions, automate inventory, and unlock sales analytics—all in one modern platform.",
        pathname: "/",
        jsonLd: k,
      }),
      s.jsxs("div", {
                    ...
                    children: [
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("span", {
                            children: "Trusted by 500+ businesses",
                          }),
                        ],
                      }),
                      s.jsxs("h1", {
                        ...
                        children: [
                          s.jsxs("div", {
                            ...
                            children: [
                              s.jsx("span", {
                                className:
                                  "text-emerald-400 text-base sm:text-lg",
                                children: "✓",
                              }),
                              s.jsx("span", {
                            ...
                            children: s.jsxs("div", {
                              ...
                              children: [
                                ...
                                s.jsxs("p", {
                                  ...
                                  children: [x.free.durationDays, " day trial"],
                                }),
                                s.jsx("div", {
                                          ...
                                          children: [
                                            ...
                                            s.jsx("p", {
                                              className:
                                                "text-2xl sm:text-3xl font-semibold text-white",
                                              children:
                                                x.enterprise.priceCents > 0
                                                  ? S(x.enterprise.priceCents)
                                                  : "Custom",
                                            }),
                                          ],
                                        }),
            ...
            s.jsx("div", {
              ...
              children: s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx(h, { onSuccess: () => r(!1), onCancel: () => r(!1) }),
                ],
              }),
            }),
          l &&
            s.jsx("div", {
              ...
              children: s.jsxs("div", {
                ...
                children: [
                  ...
                  s.jsx(p, { onSuccess: () => i(!1), onCancel: () => i(!1) }),
                ],
              }),
            }),
          s.jsx("footer", {
