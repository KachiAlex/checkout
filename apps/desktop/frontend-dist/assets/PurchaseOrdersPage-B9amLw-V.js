...
import { f as i } from "./format-BJFo2Mkz.js";
function c() {
  const { logout: c, accessToken: m, user: u } = e(),
    [p, x] = t.useState([]),
    [h, b] = t.useState([]),
    [y, f] = t.useState([]),
    [v, g] = t.useState(!1),
    ...
    F = async () => {
      ...
      if (m) {
        g(!0);
        try {
          const e = await l.get(`${n}/api/v1/purchase-orders`, {
            headers: { Authorization: `Bearer ${m}` },
          });
          x(e.data || []);
        } catch (t) {
          401 !== (null == (e = t.response) ? void 0 : e.status) &&
            a.error("Failed to load purchase orders");
        } finally {
          g(!1);
        }
      }
    ...
    O = async () => {
      if (m)
        try {
          const e = await l.get(`${n}/api/v1/suppliers`, {
            headers: { Authorization: `Bearer ${m}` },
          });
          b(e.data || []);
        } catch (e) {}
    ...
    _ = async () => {
      if (m)
        try {
          const e = await l.get(`${n}/api/v1/products`, {
            headers: { Authorization: `Bearer ${m}` },
          });
          f(e.data || []);
        } catch (e) {}
  ...
  const T = (e) => {
      const t = e.reduce((e, t) => e + t.totalCostCents, 0),
        s = Math.round(0.075 * t);
      return { subtotal: t, tax: s, total: t + s };
    },
    M = (e, t, s) => {
      const r = [...k.items],
        a = { ...r[e] };
      if ("productId" === t) {
        const e = y.find((e) => e.id === s);
        e &&
          ((a.productId = e.id),
          (a.productName = e.name),
          (a.sku = e.sku),
          (a.unitCostCents = e.costCents || e.priceCents),
          (a.totalCostCents = a.quantity * a.unitCostCents));
      } else
        ("quantity" !== t && "unitCostCents" !== t) ||
          ((a[t] = parseFloat(s) || 0),
          (a.totalCostCents = a.quantity * a.unitCostCents));
      ((r[e] = a), I({ ...k, items: r }));
    },
              ...
              s.jsxs("form", {
                onSubmit: async (e) => {
                  ...
                  if ((e.preventDefault(), !m))
                    return void a.error("Not authenticated");
                  if (!k.supplierId)
                    return void a.error("Please select a supplier");
                  if (0 === k.items.length)
                    return void a.error("Please add at least one item");
                  const r = await (async () => {
                    if (!m || !u) return null;
                    if (u.locationId) return u.locationId;
                    try {
                      const e =
                        (
                          await l.get(`${n}/api/v1/locations`, {
                            headers: { Authorization: `Bearer ${m}` },
                          })
                        ).data || [];
                  ...
                  const { subtotal: d, tax: o, total: i } = T(k.items);
                  try {
                    (w
                      ? (await l.put(
                          `${n}/api/v1/purchase-orders/${w}`,
                          {
                            locationId: r,
                            ...
                            totalCents: i,
                            expectedDeliveryDate:
                              k.expectedDeliveryDate || void 0,
                            notes: k.notes || void 0,
                          },
                          { headers: { Authorization: `Bearer ${m}` } },
                        ),
                        a.success("Purchase order updated successfully"))
                      : (await l.post(
                          `${n}/api/v1/purchase-orders`,
                          {
                            locationId: r,
                            supplierId: k.supplierId,
                            items: k.items,
                        ...
                        a.success("Purchase order created successfully")),
                      j(!1),
                      C(null),
                      I({
                        supplierId: "",
                    ...
                    a.error(
                      (null == (s = null == (t = c.response) ? void 0 : t.data)
                        ? void 0
                        : s.message) ||
                        `Failed to ${w ? "update" : "create"} purchase order`,
                    );
                  }
                },
                className: "space-y-4",
                    ...
                    children: [
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsxs("div", {
                            ...
                            children: [
                              ...
                              s.jsx("button", {
                                ...
                                onClick: () => P(!0),
                                className:
                                  "rounded-lg border border-emerald-500/50 bg-emerald-500/10 px-4 py-3 text-sm font-semibold text-emerald-400 transition hover:bg-emerald-500/20 whitespace-nowrap",
                          ...
                          D &&
                            s.jsxs("div", {
                              className:
                                "mt-3 theme-surface rounded-xl border border-white/10 p-4 space-y-3",
                              children: [
                                s.jsxs("div", {
                                  className:
                                ...
                                s.jsx("button", {
                                  ...
                                  onClick: async () => {
                                    ...
                                    if (S.name.trim())
                                      ...
                                      else a.error("Not authenticated");
                                    else a.error("Supplier name is required");
                                  },
                                  className:
                                    "w-full rounded-lg bg-gradient-to-r from-emerald-400 via-emerald-500 to-emerald-400 px-4 py-2 text-sm font-semibold text-emerald-950 transition hover:shadow-lg",
                      ...
                      s.jsxs("div", {
                        children: [
                          ...
                          s.jsx("input", {
                            type: "date",
                            value: k.expectedDeliveryDate,
                            onChange: (e) =>
                              I({ ...k, expectedDeliveryDate: e.target.value }),
                            className:
                      ...
                      s.jsxs("div", {
                        ...
                        children: [
                          ...
                          s.jsx("textarea", {
                            value: k.notes,
                            onChange: (e) => I({ ...k, notes: e.target.value }),
                            className:
                              "w-full theme-surface rounded-lg border border-white/20 bg-transparent px-4 py-3 text-base theme-text-primary focus:border-sky-400 focus:outline-none",
                            rows: 2,
                                    ...
                                    children: [
                                          ...
                                          s.jsxs("div", {
                                            ...
                                            children: [
                                              e.isNewProduct
                                                ? s.jsx("div", {
                                                    className:
                                                      "flex-1 theme-surface rounded-lg border border-emerald-500/50 bg-emerald-500/10 px-3 py-2 text-sm theme-text-primary",
                                                ...
                                                : s.jsxs("select", {
                                                    ...
                                                    className:
                                                      "flex-1 theme-surface rounded-lg border border-white/20 bg-transparent px-3 py-2 text-sm theme-text-primary focus:border-sky-400 focus:outline-none",
                                                    required: !e.isNewProduct,
                                                    children: [
                                                      s.jsx("option", {
                                                        value: "",
                                                        children:
                                              ...
                                              e.isNewProduct &&
                                                s.jsx("button", {
                                                  ...
                                                  className:
                                                    "rounded-lg border border-red-500/50 bg-red-500/10 px-3 py-2 text-sm font-semibold text-red-400 transition hover:bg-red-500/20",
                                                  children: "Cancel",
                                                }),
                                            ],
                                          }),
                                      ...
                                      s.jsx("div", {
                                        ...
                                        children: s.jsx("button", {
                                          ...
                                          className:
                                            "w-full rounded-lg border border-red-500/50 bg-red-500/10 px-3 py-2 text-sm font-semibold text-red-400 transition hover:bg-red-500/20",
                                          children: "✕",
                                        }),
                                      }),
                                    ],
                                ...
                                children: [
                                  s.jsxs("div", {
                                    ...
                                    children: [
                                      ...
                                      s.jsx("span", {
                                        className: `rounded-full px-3 py-1 text-xs font-semibold ${E(e.status)}`,
                                        children: e.status
                                          .replace("_", " ")
                                          .toUpperCase(),
                                      }),
                                  ...
                                  s.jsxs("div", {
                                    className:
                                      "grid gap-2 sm:grid-cols-3 text-sm mb-3",
                                    children: [
                                      s.jsxs("div", {
                                        children: [
                                          s.jsx("span", {
                                  ...
                                  s.jsxs("p", {
                                    className:
                                      "theme-text-secondary text-xs mt-2",
                                    children: [
                                      "Created: ",
                                      i(
                                ...
                                children: [
                                    ...
                                    s.jsxs(s.Fragment, {
                                      children: [
                                        s.jsx("button", {
                                          ...
                                          className:
                                            "rounded-full border border-blue-500/50 bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-400 transition hover:bg-blue-500/20",
                                          children: "Edit",
                                        }),
                                        s.jsx("button", {
                                          onClick: () =>
                                            (async (e) => {
                                              ...
                                              if (
                                                ...
                                                try {
                                                  (await l.patch(
                                                    `${n}/api/v1/purchase-orders/${e}/approve`,
                                                    {},
                                                    {
                                                      headers: {
                                                        Authorization: `Bearer ${m}`,
                                          ...
                                          className:
                                            "rounded-full border border-emerald-500/50 bg-emerald-500/10 px-4 py-2 text-sm font-semibold text-emerald-400 transition hover:bg-emerald-500/20",
                                          children: "Approve",
                                        }),
                                      ],
                                    }),
                                  "received" !== e.status &&
                                    ...
                                    s.jsx("button", {
                                      onClick: () =>
                                        (async (e) => {
                                          ...
                                          if (
                                            ...
                                            try {
                                              (await l.patch(
                                                `${n}/api/v1/purchase-orders/${e}/cancel`,
                                                {},
                                                {
                                                  headers: {
                                                    Authorization: `Bearer ${m}`,
                                      ...
                                      className:
                                        "rounded-full border border-red-500/50 bg-red-500/10 px-4 py-2 text-sm font-semibold text-red-400 transition hover:bg-red-500/20",
                                      children: "Cancel",
                                    }),
                                  "approved" === e.status &&
                                    s.jsx(r, {
                                      to: `/grn?poId=${e.id}`,
                                      className:
                                        "rounded-full border border-blue-500/50 bg-blue-500/10 px-4 py-2 text-sm font-semibold text-blue-400 transition hover:bg-blue-500/20 text-center",
                                      children: "Receive",
                                    }),
                                ],
                              }),
...
export { c as PurchaseOrdersPage };
