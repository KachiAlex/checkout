    ...
    j = async () => {
      if (m) {
        ...
        try {
          ...
          401 !== e.response?.status && d.error("Failed to load suppliers");
        } finally {
          h(!1);
        }
      }
              ...
              s.jsxs("form", {
                onSubmit: async (e) => {
                  if ((e.preventDefault(), m))
                    try {
                      (f
                        ? (await l.patch(`${n}/api/v1/suppliers/${f.id}`, g, {
                            headers: { Authorization: `Bearer ${m}` },
                          }),
                          d.success("Supplier updated successfully"))
                        : (await l.post(`${n}/api/v1/suppliers`, g, {
                            headers: { Authorization: `Bearer ${m}` },
                          }),
                          d.success("Supplier created successfully")),
                        b(!1),
                        y(null),
                        N({
                          name: "",
                  ...
                  else d.error("Not authenticated");
                },
                className: "space-y-4",
                children: [
                  s.jsxs("div", {
